...
ZEPHIR_INIT_CLASS(Ice_Version) {
	...
	zend_declare_class_constant_long(ice_version_ce, SL("MINOR"), 1 TSRMLS_CC);

	zend_declare_class_constant_long(ice_version_ce, SL("PATCH"), 2 TSRMLS_CC);
...
PHP_METHOD(Ice_Version, current) {
	...
	add_assoc_long_ex(return_value, SS("minor"), 1);
	add_assoc_long_ex(return_value, SS("patch"), 2);
