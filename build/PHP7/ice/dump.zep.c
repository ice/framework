...
PHP_METHOD(Ice_Dump, output) {
	...
	if (Z_TYPE_P(variable) == IS_ARRAY) {
		...
		ZEPHIR_CALL_FUNCTION(&_1$$4, "strtr", &_4, 82, &_2$$4, &_0$$4);
		zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(variable), _6$$4, _7$$4, _5$$4)
		{
			...
			ZEPHIR_CALL_FUNCTION(&_8$$5, "str_repeat", &_9, 68, &space, tab);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_11$$5, "strtr", &_4, 82, &_12$$5, &_10$$5);
			zephir_check_call_status();
			...
			if (_16$$5) {
				...
				ZEPHIR_CALL_METHOD(&_17$$7, this_ptr, "output", &_20, 83, &value, &_18$$7, &_19$$7);
				zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_23$$4, "str_repeat", &_9, 68, &space, &_22$$4);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_OBJECT) {
		...
		ZEPHIR_CALL_FUNCTION(&_25$$8, "strtr", &_4, 82, &_26$$8, &_24$$8);
		zephir_check_call_status();
		zephir_concat_self(&output, &_25$$8 TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_27$$8, "get_parent_class", &_28, 84, variable);
		zephir_check_call_status();
		if (zephir_is_true(&_27$$8)) {
			...
			ZEPHIR_CALL_FUNCTION(&_30$$9, "get_parent_class", &_28, 84, variable);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_30$$9, "strtr", &_4, 82, &_31$$9, &_29$$9);
			zephir_check_call_status();
		...
		if (zephir_instance_of_ev(variable, ice_di_ce TSRMLS_CC)) {
			ZEPHIR_CALL_FUNCTION(&_33$$10, "str_repeat", &_9, 68, &space, tab);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_35$$11, "get_object_vars", NULL, 85, variable);
			zephir_check_call_status();
			...
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_35$$11), _37$$11, _38$$11, _36$$11)
			{
				...
				ZEPHIR_CALL_FUNCTION(&_39$$12, "str_repeat", &_9, 68, &space, tab);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_41$$12, "strtr", &_4, 82, &_42$$12, &_40$$12);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_44$$12, this_ptr, "output", &_20, 83, &value, &_42$$12, &_45$$12);
				zephir_check_call_status();
			...
			do {
				...
				ZEPHIR_CALL_FUNCTION(&attr, "each", &_47, 86, variable);
				...
				ZVAL_LONG(&_49$$14, 0);
				ZEPHIR_CALL_FUNCTION(&_50$$14, "chr", &_51, 67, &_49$$14);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_53$$14, "str_repeat", &_9, 68, &space, tab);
				zephir_check_call_status();
				...
				ZEPHIR_MAKE_REF(&key);
				ZEPHIR_CALL_FUNCTION(&_55$$14, "end", &_56, 87, &key);
				ZEPHIR_UNREF(&key);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_55$$14, "strtr", &_4, 82, &_48$$14, &_54$$14);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_58$$14, this_ptr, "output", &_20, 83, &value, &_48$$14, &_49$$14);
				zephir_check_call_status();
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_60$$8, "str_repeat", &_9, 68, &space, tab);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_62$$8, "strtr", &_4, 82, &_26$$8, &_61$$8);
		zephir_check_call_status();
		...
		if (zephir_fast_in_array(&className$$8, &_64$$8 TSRMLS_CC)) {
			ZEPHIR_CALL_FUNCTION(&_65$$19, "str_repeat", &_9, 68, &space, tab);
			zephir_check_call_status();
			...
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attr), _67$$20)
			{
				...
				if (ZEPHIR_IS_STRING(&value, "__construct")) {
					...
					ZEPHIR_CALL_FUNCTION(&_70$$23, "str_repeat", &_9, 68, &space, &_69$$23);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_72$$23, "strtr", &_4, 82, &_73$$23, &_71$$23);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_76$$24, "str_repeat", &_9, 68, &space, &_75$$24);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_78$$24, "strtr", &_4, 82, &_79$$24, &_77$$24);
					zephir_check_call_status();
			...
			ZEPHIR_INIT_NVAR(&value);
			ZEPHIR_CALL_FUNCTION(&_81$$20, "str_repeat", &_9, 68, &space, tab);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_84$$8, "str_repeat", &_9, 68, &space, &_83$$8);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_LONG) {
		...
		ZEPHIR_CALL_FUNCTION(&_86$$25, "strtr", &_4, 82, &_87$$25, &_85$$25);
		zephir_check_call_status();
		ZEPHIR_CONCAT_VV(return_value, &output, &_86$$25);
		RETURN_MM();
	}
	ZEPHIR_CALL_FUNCTION(&_88, "is_float", NULL, 89, variable);
	zephir_check_call_status();
	if (zephir_is_true(&_88)) {
		...
		ZEPHIR_CALL_FUNCTION(&_90$$26, "strtr", &_4, 82, &_91$$26, &_89$$26);
		zephir_check_call_status();
	...
	if (zephir_is_numeric(variable)) {
		...
		ZEPHIR_CALL_FUNCTION(&_93$$27, "strtr", &_4, 82, &_94$$27, &_92$$27);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_STRING) {
		...
		ZEPHIR_CALL_FUNCTION(&_96$$28, "htmlentities", NULL, 90, variable, &_98$$28, &_97$$28);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_99$$28, "nl2br", NULL, 91, &_96$$28);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_99$$28, "strtr", &_4, 82, &_97$$28, &_95$$28);
		zephir_check_call_status();
	...
	if ((Z_TYPE_P(variable) == IS_TRUE || Z_TYPE_P(variable) == IS_FALSE)) {
		...
		ZEPHIR_CALL_FUNCTION(&_101$$29, "strtr", &_4, 82, &_102$$29, &_100$$29);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_NULL) {
		...
		ZEPHIR_CALL_FUNCTION(&_105$$30, "strtr", &_4, 82, &_106$$30, &_104$$30);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_108, "strtr", &_4, 82, &_109, &_107);
	zephir_check_call_status();
...
PHP_METHOD(Ice_Dump, variable) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("strtr", NULL, 82, &_2, &_0);
	zephir_check_call_status();
	RETURN_MM();
