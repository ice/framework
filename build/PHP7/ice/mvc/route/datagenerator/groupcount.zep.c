...
PHP_METHOD(Ice_Mvc_Route_DataGenerator_GroupCount, processChunk) {
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(regexToRoutesMap), _1, _2, _0)
	{
		...
		ZEPHIR_CALL_FUNCTION(&_4$$3, "max", &_5, 32, &numGroups, &numVariables);
		...
		ZEPHIR_CALL_FUNCTION(&_4$$3, "str_repeat", &_9, 68, &_7$$3, &_8$$3);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_14, "utf8_encode", NULL, 112, &regex);
	zephir_check_call_status();
