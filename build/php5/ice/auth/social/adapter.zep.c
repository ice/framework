...
PHP_METHOD(Ice_Auth_Social_Adapter, __construct) {
	...
	if (_15) {
		...
		zephir_array_fast_append(_18$$8, _19$$8);
		ZEPHIR_CALL_METHOD(NULL, _17$$8, "__construct", NULL, 14, _18$$8);
		zephir_check_call_status();
...
PHP_METHOD(Ice_Auth_Social_Adapter, __call) {
	...
	if (zephir_start_with_str(name, SL("get"))) {
		...
		ZEPHIR_CALL_FUNCTION(&key, "lcfirst", NULL, 19, _1$$3);
		zephir_check_call_status();
...
PHP_METHOD(Ice_Auth_Social_Adapter, getAuthUrl) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "http_build_query", NULL, 20, _1);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_3, "urldecode", NULL, 21, _2);
	zephir_check_call_status();
...
PHP_METHOD(Ice_Auth_Social_Adapter, call) {
	...
	ZEPHIR_CALL_FUNCTION(&curl, "curl_init", NULL, 22);
	zephir_check_call_status();
	if (method == 0) {
		ZEPHIR_CALL_FUNCTION(&_0$$3, "http_build_query", &_1, 20, params);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_2$$3, "urldecode", &_3, 21, _0$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_4$$3);
		ZEPHIR_CONCAT_VSV(_4$$3, url, "?", _2$$3);
		ZEPHIR_SINIT_VAR(_5$$3);
		ZVAL_LONG(&_5$$3, 10002);
		ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_6, 23, curl, &_5$$3, _4$$3);
		zephir_check_call_status();
	} else {
		ZEPHIR_SINIT_VAR(_7$$4);
		ZVAL_LONG(&_7$$4, 10002);
		ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_6, 23, curl, &_7$$4, url);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_7$$4);
		ZVAL_LONG(&_7$$4, 47);
		ZEPHIR_SINIT_VAR(_8$$4);
		ZVAL_LONG(&_8$$4, 1);
		ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_6, 23, curl, &_7$$4, &_8$$4);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_9$$4, "http_build_query", &_1, 20, params);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_10$$4, "urldecode", &_3, 21, _9$$4);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_7$$4);
		ZVAL_LONG(&_7$$4, 10015);
		ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_6, 23, curl, &_7$$4, _10$$4);
		zephir_check_call_status();
	}
	ZEPHIR_SINIT_VAR(_11);
	ZVAL_LONG(&_11, 19913);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_6, 23, curl, &_11, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	ZEPHIR_SINIT_NVAR(_11);
	ZVAL_LONG(&_11, 64);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_6, 23, curl, &_11, ZEPHIR_GLOBAL(global_false));
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&result, "curl_exec", NULL, 24, curl);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "curl_close", NULL, 25, curl);
	zephir_check_call_status();
	if (parse) {
