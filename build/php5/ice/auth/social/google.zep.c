...
PHP_METHOD(Ice_Auth_Social_Google, __construct) {
	...
	ZEPHIR_CALL_PARENT(NULL, ice_auth_social_google_ce, getThis(), "__construct", &_1, 68, config);
...
PHP_METHOD(Ice_Auth_Social_Google, getBirthday) {
	...
	if (zephir_is_true(_0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_4$$3, "date", &_5, 39, &_3$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_11$$3, "strtotime", NULL, 69, _10$$3);
		zephir_check_call_status();
		ZEPHIR_SINIT_VAR(_12$$3);
		ZVAL_STRING(&_12$$3, "d.m.Y", 0);
		ZEPHIR_RETURN_CALL_FUNCTION("date", &_5, 39, &_12$$3, _11$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
	RETURN_MM_NULL();
