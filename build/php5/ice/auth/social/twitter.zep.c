...
PHP_METHOD(Ice_Auth_Social_Twitter, __construct) {
	...
	ZEPHIR_CALL_PARENT(NULL, ice_auth_social_twitter_ce, getThis(), "__construct", &_1, 68, config);
...
PHP_METHOD(Ice_Auth_Social_Twitter, authenticate) {
	...
	if (_0) {
		...
		if (!(zephir_is_true(_2$$3))) {
			...
			ZEPHIR_CALL_METHOD(&_3$$4, this_ptr, "prepareurlparams", &_4, 70, accessTokenUrl, params);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(NULL, "parse_str", NULL, 71, _3$$4, tokenInfo);
		...
		if (zephir_is_true(_12$$3)) {
			...
			ZEPHIR_CALL_METHOD(&_16$$6, this_ptr, "prepareurlparams", &_4, 70, getDataUrl, params, _18$$6);
			zephir_check_call_status();
...
PHP_METHOD(Ice_Auth_Social_Twitter, prepareAuthParams) {
	...
	ZEPHIR_CALL_METHOD(&params, this_ptr, "prepareurlparams", NULL, 70, requestTokenUrl, _0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_2);
	ZVAL_LONG(_2, 0);
	ZEPHIR_INIT_VAR(_3);
	...
	ZEPHIR_CALL_FUNCTION(NULL, "parse_str", NULL, 71, requestTokens, requestTokens);
...
PHP_METHOD(Ice_Auth_Social_Twitter, prepareUrlParams) {
	...
	ZEPHIR_INIT_VAR(_3);
	ZEPHIR_CALL_FUNCTION(&_4, "rand", NULL, 38);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_5, "uniqid", NULL, 72, _4, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	zephir_md5(_3, _5);
	...
	ZEPHIR_CALL_FUNCTION(NULL, "ksort", NULL, 73, params);
	ZEPHIR_UNREF(params);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_6, "urlencode", &_7, 74, url);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_8, "http_build_query", NULL, 19, params);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_9, "urlencode", &_7, 74, _8);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_14, "array_map", NULL, 46, &_11, params);
	zephir_check_call_status();
