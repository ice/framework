...
PHP_METHOD(Ice_Cli_Websocket_Client, connect) {
	...
	ZEPHIR_CALL_FUNCTION(&addr, "parse_url", NULL, 75, address);
	...
	ZEPHIR_CALL_FUNCTION(&_10, "fsockopen", NULL, 76, _8, _9);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(NULL, "array_unshift", NULL, 77, headers, _16);
	...
	ZEPHIR_CALL_FUNCTION(&_37, "sha1", &_38, 58, _36);
	zephir_check_call_status();
	ZEPHIR_SINIT_VAR(_39);
	ZVAL_STRING(&_39, "H*", 0);
	ZEPHIR_CALL_FUNCTION(&_40, "pack", &_41, 78, &_39, _37);
	zephir_check_call_status();
	...
	if (!ZEPHIR_IS_IDENTICAL(_33, _42)) {
		...
		ZEPHIR_CALL_FUNCTION(&_49$$9, "sha1", &_38, 58, _48$$9);
		zephir_check_call_status();
		ZEPHIR_SINIT_VAR(_50$$9);
		ZVAL_STRING(&_50$$9, "H*", 0);
		ZEPHIR_CALL_FUNCTION(&_51$$9, "pack", &_41, 78, &_50$$9, _49$$9);
		zephir_check_call_status();
...
PHP_METHOD(Ice_Cli_Websocket_Client, normalizeHeaders) {
	...
	for (
	  ...
	  ; zend_hash_move_forward_ex(_1, &_0)
		...
		ZVAL_LONG(&_4$$3, 5);
		ZEPHIR_CALL_FUNCTION(&_5$$3, "strncmp", &_6, 79, name, &_3$$3, &_4$$3);
		zephir_check_call_status();
		...
		if (!ZEPHIR_IS_FALSE_IDENTICAL(name)) {
			...
			ZVAL_STRING(&_13$$5, "-", 0);
			ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_14, 80, _9$$5, &_13$$5);
			zephir_check_call_status();
...
PHP_METHOD(Ice_Cli_Websocket_Client, send) {
	...
	ZEPHIR_INIT_VAR(_2);
	ZVAL_BOOL(_2, 1);
	ZEPHIR_RETURN_CALL_PARENT(ice_cli_websocket_client_ce, getThis(), "senddata", &_0, 81, _1, data, opcode, _2);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Ice_Cli_Websocket_Client, run) {
	...
	while (1) {
		...
		if (zephir_isset_property(this_ptr, SS("tick") TSRMLS_CC)) {
			...
			ZEPHIR_CALL_FUNCTION(&_1$$4, "call_user_func", &_2, 82, _0$$4, this_ptr);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_7$$3, "stream_select", &_8, 83, changed, _5$$3, _6$$3, _4$$3);
			...
			for (
			  ...
			  ; zend_hash_move_forward_ex(_10$$6, &_9$$6)
				...
				if (_13$$7) {
					...
					ZEPHIR_CALL_FUNCTION(NULL, "call_user_func", &_2, 82, _14$$8, message, this_ptr);
					zephir_check_call_status();
				}
			}
		}
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(NULL, "usleep", &_17, 30, _15$$3);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
