...
PHP_METHOD(Ice_Cli_Websocket_Server, __construct) {
	...
	if (zephir_fast_count_int(options TSRMLS_CC)) {
		...
		for (
		  ...
		  ; zend_hash_move_forward_ex(_4$$4, &_3$$4)
			...
			ZEPHIR_CALL_FUNCTION(NULL, "stream_context_set_option", &_7, 88, context, &_6$$5, key, value);
			zephir_check_call_status();
		}
	}
	...
	ZEPHIR_MAKE_REF(_11);
	ZEPHIR_MAKE_REF(_15);
	ZEPHIR_CALL_FUNCTION(&_17, "stream_socket_server", NULL, 89, _14, _11, _15, _16, context);
	ZEPHIR_UNREF(_11);
	ZEPHIR_UNREF(_15);
	zephir_check_call_status();
			...
			for (
			  ...
			  ; zend_hash_move_forward_ex(_12$$7, &_11$$7)
				...
				if (ZEPHIR_IS_IDENTICAL(socket, _14$$8)) {
					...
					ZEPHIR_CALL_FUNCTION(&tmp, "stream_socket_accept", &_16, 90, _15$$9);
					zephir_check_call_status();
					if (!ZEPHIR_IS_FALSE_IDENTICAL(tmp)) {
						...
						if (zephir_is_true(_17$$10)) {
							...
							if (zephir_array_isset_string(_19$$11, SS("connect"))) {
								...
								ZEPHIR_CALL_FUNCTION(NULL, "call_user_func", &_3, 85, _21$$12, _23$$12, this_ptr);
								zephir_check_call_status();
							}
						}
					}
					...
					if (_25$$13) {
						...
						if (zephir_array_isset_string(_28$$14, SS("disconnect"))) {
							...
							ZEPHIR_CALL_FUNCTION(NULL, "call_user_func", &_3, 85, _30$$15, _32$$15, this_ptr);
							zephir_check_call_status();
						}
			...
			for (
			  ...
			  ; zend_hash_move_forward_ex(_38$$7, &_37$$7)
				...
				if (zephir_array_isset_string(_40$$17, SS("message"))) {
					...
					ZEPHIR_CALL_FUNCTION(NULL, "call_user_func", &_3, 85, _42$$18, _43$$18, _44$$18, this_ptr);
					zephir_check_call_status();
				}
			}
		}
...
PHP_METHOD(Ice_Cli_Websocket_Server, connect) {
	...
	ZEPHIR_CALL_FUNCTION(&_5, "preg_replace", NULL, 91, _2, _4, headers);
	...
	if (_40) {
		...
		ZEPHIR_CALL_FUNCTION(&_43, "call_user_func", NULL, 85, _42, client, this_ptr);
		zephir_check_call_status();
