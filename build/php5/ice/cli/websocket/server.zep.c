...
PHP_METHOD(Ice_Cli_Websocket_Server, __construct) {
	...
	ZEPHIR_CALL_FUNCTION(&context, "stream_context_create", NULL, 84);
	zephir_check_call_status();
	if (zephir_fast_count_int(options TSRMLS_CC)) {
		...
		for (
		  ...
		  ; zend_hash_move_forward_ex(_4$$4, &_3$$4)
			...
			ZEPHIR_CALL_FUNCTION(NULL, "stream_context_set_option", &_7, 85, context, &_6$$5, key, value);
			zephir_check_call_status();
		}
	}
	...
	ZEPHIR_MAKE_REF(_11);
	ZEPHIR_MAKE_REF(_15);
	ZEPHIR_CALL_FUNCTION(&_17, "stream_socket_server", NULL, 86, _14, _11, _15, _16, context);
	ZEPHIR_UNREF(_11);
	ZEPHIR_UNREF(_15);
	zephir_check_call_status();
...
PHP_METHOD(Ice_Cli_Websocket_Server, run) {
	...
	if (zephir_array_isset_string(_0, SS("boot"))) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "call_user_func", &_3, 82, _2$$3, this_ptr);
		zephir_check_call_status();
	}
	while (1) {
		if (!(1)) {
		...
		if (zephir_array_isset_string(_4$$4, SS("tick"))) {
			...
			ZEPHIR_CALL_FUNCTION(&_7$$5, "call_user_func", &_3, 82, _6$$5, this_ptr);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&stream, "stream_select", &_10, 83, changed, write, except, _8$$4);
			...
			for (
			  ...
			  ; zend_hash_move_forward_ex(_12$$7, &_11$$7)
				...
				if (ZEPHIR_IS_IDENTICAL(socket, _14$$8)) {
					...
					ZEPHIR_CALL_FUNCTION(&tmp, "stream_socket_accept", &_16, 87, _15$$9);
					zephir_check_call_status();
					if (!ZEPHIR_IS_FALSE_IDENTICAL(tmp)) {
						...
						if (zephir_is_true(_17$$10)) {
							...
							if (zephir_array_isset_string(_19$$11, SS("connect"))) {
								...
								ZEPHIR_CALL_FUNCTION(NULL, "call_user_func", &_3, 82, _21$$12, _23$$12, this_ptr);
								zephir_check_call_status();
							}
						}
					}
					...
					if (_25$$13) {
						...
						if (zephir_array_isset_string(_28$$14, SS("disconnect"))) {
							...
							ZEPHIR_CALL_FUNCTION(NULL, "call_user_func", &_3, 82, _30$$15, _32$$15, this_ptr);
							zephir_check_call_status();
						}
			...
			for (
			  ...
			  ; zend_hash_move_forward_ex(_38$$7, &_37$$7)
				...
				if (zephir_array_isset_string(_40$$17, SS("message"))) {
					...
					ZEPHIR_CALL_FUNCTION(NULL, "call_user_func", &_3, 82, _42$$18, _43$$18, _44$$18, this_ptr);
					zephir_check_call_status();
				}
			}
		}
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(NULL, "usleep", &_49, 30, _45$$4);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Ice_Cli_Websocket_Server, connect) {
	...
	ZEPHIR_CALL_FUNCTION(&_5, "preg_replace", NULL, 88, _2, _4, headers);
	...
	if (_40) {
		...
		ZEPHIR_CALL_FUNCTION(&_43, "call_user_func", NULL, 82, _42, client, this_ptr);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_50, "sha1", NULL, 58, _47, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
