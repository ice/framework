...
PHP_METHOD(Ice_Cli_Websocket_Websocket, sendData) {
	...
	while (1) {
		...
		if (_9$$3) {
			ZEPHIR_CALL_FUNCTION(&_5$$3, "get_resource_type", &_10, 30, socket);
			zephir_check_call_status();
		...
		if (_11$$3) {
			...
			if (!(_13$$4)) {
				ZEPHIR_CALL_FUNCTION(&_14$$4, "stream_get_meta_data", &_15, 31, socket);
				zephir_check_call_status();
...
PHP_METHOD(Ice_Cli_Websocket_Websocket, receiveClear) {
	...
	do {
		ZEPHIR_CALL_FUNCTION(&buff, "fread", &_0, 32, socket, read);
		zephir_check_call_status();
		if (ZEPHIR_IS_FALSE_IDENTICAL(buff)) {
			RETURN_MM_STRING("", 1);
		}
		zephir_concat_self(&data, buff TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&meta, "stream_get_meta_data", &_1, 31, socket);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&read, "min", &_5, 33, _4$$3, _3$$3);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_6$$3);
		ZVAL_LONG(&_6$$3, 1000);
		ZEPHIR_CALL_FUNCTION(NULL, "usleep", &_7, 34, &_6$$3);
		zephir_check_call_status();
	...
	if (zephir_fast_strlen_ev(data) == 1) {
		ZEPHIR_CALL_METHOD(&_10$$5, this_ptr, "receiveclear", NULL, 35, socket);
		zephir_check_call_status();
...
PHP_METHOD(Ice_Cli_Websocket_Websocket, receive) {
	...
	ZEPHIR_SINIT_VAR(_0);
	ZVAL_LONG(&_0, 2);
	ZEPHIR_CALL_FUNCTION(&data, "fread", &_1, 32, socket, &_0);
	zephir_check_call_status();
	if (zephir_fast_strlen_ev(data) == 1) {
		ZEPHIR_SINIT_VAR(_2$$3);
		ZVAL_LONG(&_2$$3, 1);
		ZEPHIR_CALL_FUNCTION(&_3$$3, "fread", &_1, 32, socket, &_2$$3);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_6, "ord", &_7, 36, _5);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_9, "ord", &_7, 36, _8);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(opcode);
	...
	ZEPHIR_CALL_FUNCTION(&_11, "ord", &_7, 36, _10);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_13, "ord", &_7, 36, _12);
	zephir_check_call_status();
	...
	if (ZEPHIR_GT_LONG(length, 125)) {
		if (ZEPHIR_IS_LONG_IDENTICAL(length, 126)) {
			...
			ZVAL_LONG(&_14$$5, 2);
			ZEPHIR_CALL_FUNCTION(&tmp, "fread", &_1, 32, socket, &_14$$5);
			zephir_check_call_status();
		} else {
		...
		while (1) {
			...
			ZEPHIR_CALL_FUNCTION(&_16$$7, "ord", &_7, 36, _15$$7);
			zephir_check_call_status();
			ZEPHIR_SINIT_NVAR(_17$$7);
			ZVAL_STRING(&_17$$7, "%08b", 0);
			ZEPHIR_CALL_FUNCTION(&_18$$7, "sprintf", &_19, 13, &_17$$7, _16$$7);
			zephir_check_call_status();
			zephir_concat_self(&length, _18$$7 TSRMLS_CC);
			i++;
		}
		ZEPHIR_CALL_FUNCTION(&_20$$5, "bindec", NULL, 37, length);
		zephir_check_call_status();
	...
	if (masked) {
		...
		ZVAL_LONG(&_21$$8, 4);
		ZEPHIR_CALL_FUNCTION(&mask, "fread", &_1, 32, socket, &_21$$8);
		zephir_check_call_status();
	...
	if (ZEPHIR_GT_LONG(length, 0)) {
		...
		do {
			...
			ZEPHIR_CALL_FUNCTION(&_23$$11, "min", &_24, 33, length, _22$$11);
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(&buff, "fread", &_1, 32, socket, _23$$11);
			zephir_check_call_status();
			if (ZEPHIR_IS_FALSE_IDENTICAL(buff)) {
				RETURN_MM_BOOL(0);
			}
	...
	if (fin) {
		...
		ZEPHIR_CALL_METHOD(&_31, this_ptr, "receive", NULL, 38, socket);
		zephir_check_call_status();
...
PHP_METHOD(Ice_Cli_Websocket_Websocket, encode) {
	...
	ZEPHIR_CALL_FUNCTION(&_5, "sprintf", &_6, 13, &_4, _3);
	zephir_check_call_status();
	...
	ZVAL_LONG(&_4, 8);
	ZEPHIR_CALL_FUNCTION(&_16, "str_split", NULL, 40, head, &_4);
	zephir_check_call_status();
	...
	for (
	  ...
	  ; zend_hash_move_forward_ex(_18, &_17)
		...
		ZEPHIR_CALL_FUNCTION(&_20$$6, "bindec", &_21, 37, binstr);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_22$$6);
		ZVAL_LONG(&_22$$6, zephir_get_intval(_20$$6));
		ZEPHIR_CALL_FUNCTION(&_23$$6, "chr", &_24, 41, &_22$$6);
		zephir_check_call_status();
	...
	if (masked) {
		...
		while (1) {
			...
			ZVAL_LONG(&_26$$8, 255);
			ZEPHIR_CALL_FUNCTION(&_27$$8, "rand", &_28, 42, &_25$$8, &_26$$8);
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(&_29$$8, "chr", &_24, 41, _27$$8);
			zephir_check_call_status();
...
PHP_METHOD(Ice_Cli_Websocket_Websocket, console) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_4, "date", NULL, 43, _0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_5);
	...
	if (zephir_is_true(_6)) {
		...
		ZEPHIR_CALL_CE_STATIC(&_7$$4, ice_cli_console_ce, "color", &_8, 44, text, color, _9$$4, bgColor);
		zephir_check_call_status();
...
PHP_METHOD(Ice_Cli_Websocket_Websocket, getMemoryUsage) {
	...
	ZEPHIR_CALL_FUNCTION(&size, "memory_get_usage", NULL, 45);
	zephir_check_call_status();
	if (!(human)) {
		RETURN_CCTOR(size);
	}
	...
	ZEPHIR_SINIT_VAR(_1);
	ZVAL_LONG(&_1, 1024);
	ZEPHIR_CALL_FUNCTION(&_2, "log", NULL, 46, size, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(i);
	ZVAL_DOUBLE(i, zephir_floor(_2 TSRMLS_CC));
	ZEPHIR_INIT_NVAR(_0);
