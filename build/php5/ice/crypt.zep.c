...
PHP_METHOD(Ice_Crypt, encrypt) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "serialize", NULL, 15, text);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&value, this_ptr, "addpadding", NULL, 0, _0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "doencrypt", NULL, 0, value, iv);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&value, "base64_encode", &_2, 16, _1);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_3, "base64_encode", &_2, 16, iv);
	zephir_check_call_status();
	...
	ZEPHIR_RETURN_CALL_FUNCTION("base64_encode", &_2, 16, _4);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Ice_Crypt, doEncrypt) {
	...
	ZEPHIR_SINIT_VAR(_4);
	ZVAL_LONG(&_4, 1);
	ZEPHIR_RETURN_CALL_FUNCTION("openssl_encrypt", NULL, 97, value, _2, _3, &_4, iv);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Ice_Crypt, doDecrypt) {
	...
	ZEPHIR_SINIT_VAR(_4);
	ZVAL_LONG(&_4, 1);
	ZEPHIR_RETURN_CALL_FUNCTION("openssl_decrypt", NULL, 98, value, _2, _3, &_4, iv);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Ice_Crypt, getJsonPayload) {
	...
	array_init(payload);
	ZEPHIR_CALL_FUNCTION(&_0, "base64_decode", NULL, 17, text);
	zephir_check_call_status();
...
PHP_METHOD(Ice_Crypt, hash) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("hash_hmac", NULL, 28, &_1, value, _0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Ice_Crypt, addPadding) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "chr", NULL, 41, pad);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_4, "str_repeat", NULL, 99, _3, pad);
	zephir_check_call_status();
...
PHP_METHOD(Ice_Crypt, stripPadding) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "ord", NULL, 36, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Ice_Crypt, paddingIsValid) {
	...
	ZEPHIR_SINIT_VAR(_3);
	ZVAL_LONG(&_3, pad);
	ZEPHIR_CALL_FUNCTION(&_4, "str_repeat", NULL, 99, _2, &_3);
	zephir_check_call_status();
...
PHP_METHOD(Ice_Crypt, getIvSize) {
	...
	ZEPHIR_INIT_VAR(_2);
	ZEPHIR_CONCAT_VSV(_2, _0, "-", _1);
	ZEPHIR_RETURN_CALL_FUNCTION("openssl_cipher_iv_length", NULL, 100, _2);
	zephir_check_call_status();
	RETURN_MM();
