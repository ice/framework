...
PHP_METHOD(Ice_Crypt, doEncrypt) {
	...
	ZEPHIR_SINIT_VAR(_4);
	ZVAL_LONG(&_4, 1);
	ZEPHIR_RETURN_CALL_FUNCTION("openssl_encrypt", NULL, 63, value, _2, _3, &_4, iv);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Ice_Crypt, doDecrypt) {
	...
	ZEPHIR_SINIT_VAR(_4);
	ZVAL_LONG(&_4, 1);
	ZEPHIR_RETURN_CALL_FUNCTION("openssl_decrypt", NULL, 64, value, _2, _3, &_4, iv);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Ice_Crypt, addPadding) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "chr", NULL, 65, pad);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_4, "str_repeat", NULL, 66, _3, pad);
	zephir_check_call_status();
...
PHP_METHOD(Ice_Crypt, stripPadding) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "ord", NULL, 67, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Ice_Crypt, paddingIsValid) {
	...
	ZEPHIR_SINIT_VAR(_3);
	ZVAL_LONG(&_3, pad);
	ZEPHIR_CALL_FUNCTION(&_4, "str_repeat", NULL, 66, _2, &_3);
	zephir_check_call_status();
...
PHP_METHOD(Ice_Crypt, getIvSize) {
	...
	ZEPHIR_INIT_VAR(_2);
	ZEPHIR_CONCAT_VSV(_2, _0, "-", _1);
	ZEPHIR_RETURN_CALL_FUNCTION("openssl_cipher_iv_length", NULL, 68, _2);
	zephir_check_call_status();
	RETURN_MM();
