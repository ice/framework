	...
	if (_0) {
		...
		do {
			if (ZEPHIR_IS_STRING(driver, "oci")) {
				...
				ZEPHIR_CALL_METHOD(NULL, _3$$5, "__construct", NULL, 98, _4$$5, user, password, options);
			...
			if (ZEPHIR_IS_STRING(driver, "mongodb")) {
				...
				ZEPHIR_CALL_METHOD(NULL, _7$$6, "__construct", NULL, 99, dsn$$6, name, options);
				zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(NULL, _8$$7, "__construct", NULL, 98, _10$$7, user, password, options);
			zephir_check_call_status();
