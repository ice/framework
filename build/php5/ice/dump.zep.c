...
PHP_METHOD(Ice_Dump, output) {
	...
	if (Z_TYPE_P(variable) == IS_ARRAY) {
		...
		ZEPHIR_CALL_FUNCTION(&_5$$4, "strtr", &_8, 114, _0$$4, _4$$4);
		zephir_check_call_status();
		zephir_concat_self(&output, _5$$4 TSRMLS_CC);
		zephir_is_iterable(variable, &_10$$4, &_9$$4, 0, 0, "ice/dump.zep", 169);
		for (
		  ...
		  ; zend_hash_move_forward_ex(_10$$4, &_9$$4)
			...
			ZEPHIR_CALL_FUNCTION(&_12$$5, "str_repeat", &_13, 96, space, tab);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_17$$5, "strtr", &_8, 114, _14$$5, _16$$5);
			zephir_check_call_status();
			...
			if (_22$$5) {
				...
				ZEPHIR_CALL_METHOD(&_23$$7, this_ptr, "output", &_26, 115, value, _24$$7, _25$$7);
		...
		ZEPHIR_CALL_FUNCTION(&_29$$4, "str_repeat", &_13, 96, space, &_28$$4);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_OBJECT) {
		...
		ZEPHIR_CALL_FUNCTION(&_33$$8, "strtr", &_8, 114, _30$$8, _32$$8);
		zephir_check_call_status();
		zephir_concat_self(&output, _33$$8 TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_35$$8, "get_parent_class", &_36, 116, variable);
		zephir_check_call_status();
		if (zephir_is_true(_35$$8)) {
			...
			ZEPHIR_CALL_FUNCTION(&_40$$9, "get_parent_class", &_36, 116, variable);
			zephir_check_call_status();
			zephir_array_update_string(&_39$$9, SL(":parent"), &_40$$9, PH_COPY | PH_SEPARATE);
			ZEPHIR_CALL_FUNCTION(&_40$$9, "strtr", &_8, 114, _37$$9, _39$$9);
			zephir_check_call_status();
		...
		if (zephir_fast_in_array(className$$8, _43$$8 TSRMLS_CC)) {
			ZEPHIR_CALL_FUNCTION(&_45$$10, "str_repeat", &_13, 96, space, tab);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_48$$11, "get_object_vars", NULL, 117, variable);
			zephir_check_call_status();
			zephir_is_iterable(_48$$11, &_50$$11, &_49$$11, 0, 0, "ice/dump.zep", 192);
			for (
			  ...
			  ; zend_hash_move_forward_ex(_50$$11, &_49$$11)
				...
				ZEPHIR_CALL_FUNCTION(&_52$$12, "str_repeat", &_13, 96, space, tab);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_56$$12, "strtr", &_8, 114, _53$$12, _55$$12);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_59$$12, this_ptr, "output", &_26, 115, value, _57$$12, _60$$12);
				zephir_check_temp_parameter(_57$$12);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(_57$$12);
			...
			zephir_check_call_status();
			zephir_is_iterable(_65$$13, &_67$$13, &_66$$13, 0, 0, "ice/dump.zep", 215);
			for (
			  ...
			  ; zend_hash_move_forward_ex(_67$$13, &_66$$13)
				...
				zephir_check_call_status();
				ZEPHIR_CALL_FUNCTION(&_73$$14, "str_repeat", &_13, 96, space, tab);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_77$$14, "strtr", &_8, 114, _74$$14, _76$$14);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_80$$14, this_ptr, "output", &_26, 115, value, _78$$14, _81$$14);
				zephir_check_temp_parameter(_78$$14);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(_78$$14);
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_83$$8, "str_repeat", &_13, 96, space, tab);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_89$$8, "strtr", &_8, 114, _84$$8, _88$$8);
		zephir_check_call_status();
		...
		if (zephir_fast_in_array(className$$8, _92$$8 TSRMLS_CC)) {
			ZEPHIR_CALL_FUNCTION(&_93$$17, "str_repeat", &_13, 96, space, tab);
			zephir_check_call_status();
			...
			zephir_is_iterable(attr, &_97$$18, &_96$$18, 0, 0, "ice/dump.zep", 233);
			for (
			  ...
			  ; zend_hash_move_forward_ex(_97$$18, &_96$$18)
				...
				if (ZEPHIR_IS_STRING(value, "__construct")) {
					...
					ZEPHIR_CALL_FUNCTION(&_101$$21, "str_repeat", &_13, 96, space, &_100$$21);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_107$$21, "strtr", &_8, 114, _102$$21, _106$$21);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_111$$22, "str_repeat", &_13, 96, space, &_110$$22);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_117$$22, "strtr", &_8, 114, _112$$22, _116$$22);
					zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_120$$18, "str_repeat", &_13, 96, space, tab);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_124$$8, "str_repeat", &_13, 96, space, &_123$$8);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_LONG) {
		...
		ZEPHIR_CALL_FUNCTION(&_128$$23, "strtr", &_8, 114, _125$$23, _127$$23);
		zephir_check_call_status();
		ZEPHIR_CONCAT_VV(return_value, output, _128$$23);
		RETURN_MM();
	}
	ZEPHIR_CALL_FUNCTION(&_130, "is_float", NULL, 119, variable);
	zephir_check_call_status();
	if (zephir_is_true(_130)) {
		...
		ZEPHIR_CALL_FUNCTION(&_134$$24, "strtr", &_8, 114, _131$$24, _133$$24);
		zephir_check_call_status();
	...
	if (zephir_is_numeric(variable)) {
		...
		ZEPHIR_CALL_FUNCTION(&_139$$25, "strtr", &_8, 114, _136$$25, _138$$25);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_STRING) {
		...
		ZEPHIR_CALL_FUNCTION(&_144$$26, "htmlentities", NULL, 120, variable, &_146$$26, &_147$$26);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_148$$26, "nl2br", NULL, 121, _144$$26);
		zephir_check_call_status();
		zephir_array_update_string(&_143$$26, SL(":var"), &_148$$26, PH_COPY | PH_SEPARATE);
		ZEPHIR_CALL_FUNCTION(&_148$$26, "strtr", &_8, 114, _141$$26, _143$$26);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_BOOL) {
		...
		ZEPHIR_CALL_FUNCTION(&_152$$27, "strtr", &_8, 114, _149$$27, _151$$27);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_NULL) {
		...
		ZEPHIR_CALL_FUNCTION(&_158$$28, "strtr", &_8, 114, _155$$28, _157$$28);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_163, "strtr", &_8, 114, _160, _162);
	zephir_check_call_status();
...
PHP_METHOD(Ice_Dump, variable) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("strtr", NULL, 114, _0, _2);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Ice_Dump, vars) {
	...
	zephir_is_iterable(_0, &_2, &_1, 0, 0, "ice/dump.zep", 306);
	for (
