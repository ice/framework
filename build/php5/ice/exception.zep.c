...
PHP_METHOD(Ice_Exception, __construct) {
	...
	if (Z_TYPE_P(message) == IS_ARRAY) {
		...
		ZVAL_LONG(&_1$$3, 1);
		ZEPHIR_CALL_FUNCTION(&values, "array_slice", NULL, 122, message, &_1$$3);
		zephir_check_call_status();
		ZEPHIR_OBS_VAR(str);
	...
	if (zephir_is_true(_2)) {
		...
		if (zephir_fast_count_int(_8$$6 TSRMLS_CC)) {
			ZEPHIR_CALL_FUNCTION(&message, "strtr", NULL, 114, str, values);
			zephir_check_call_status();
		} else {
...
PHP_METHOD(Ice_Exception, getFullTraceAsString) {
	...
	for (
	  ...
	  ; zend_hash_move_forward_ex(_2, &_1)
		...
		ZEPHIR_CALL_FUNCTION(&_24$$3, "sprintf", &_25, 13, &_22$$3, &_23$$3, _15$$3, _18$$3, args);
		zephir_check_call_status();
...
PHP_METHOD(Ice_Exception, errorHandler) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "error_reporting", NULL, 123);
	zephir_check_call_status();
	if (((int) (zephir_get_numberval(_0)) & code)) {
		...
		ZVAL_LONG(_4$$3, line);
		ZEPHIR_CALL_METHOD(NULL, _1$$3, "__construct", NULL, 124, message, _2$$3, _3$$3, file, _4$$3);
		zephir_check_call_status();
...
PHP_METHOD(Ice_Exception, shutdownHandler) {
	...
	ZEPHIR_CALL_FUNCTION(&e, "error_get_last", NULL, 125);
	zephir_check_call_status();
	_0 = Z_TYPE_P(e) == IS_ARRAY;
	if (_0) {
		zephir_array_fetch_string(&_1, e, SL("type"), PH_NOISY | PH_READONLY, "ice/exception.zep", 153 TSRMLS_CC);
		ZEPHIR_INIT_VAR(_2);
	...
	if (_0) {
		ZEPHIR_CALL_FUNCTION(NULL, "ob_get_level", NULL, 126);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(NULL, "ob_clean", NULL, 127);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_4$$3);
		object_init_ex(_4$$3, zephir_get_internal_ce(SS("errorexception") TSRMLS_CC));
		zephir_array_fetch_string(&_5$$3, e, SL("message"), PH_NOISY | PH_READONLY, "ice/exception.zep", 158 TSRMLS_CC);
		zephir_array_fetch_string(&_6$$3, e, SL("type"), PH_NOISY | PH_READONLY, "ice/exception.zep", 158 TSRMLS_CC);
		zephir_array_fetch_string(&_7$$3, e, SL("file"), PH_NOISY | PH_READONLY, "ice/exception.zep", 158 TSRMLS_CC);
		zephir_array_fetch_string(&_8$$3, e, SL("line"), PH_NOISY | PH_READONLY, "ice/exception.zep", 158 TSRMLS_CC);
		ZEPHIR_INIT_VAR(_9$$3);
		ZVAL_LONG(_9$$3, 0);
		ZEPHIR_CALL_METHOD(NULL, _4$$3, "__construct", NULL, 124, _5$$3, _6$$3, _9$$3, _7$$3, _8$$3);
		zephir_check_call_status();
