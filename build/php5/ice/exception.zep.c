...
PHP_METHOD(Ice_Exception, __construct) {
	...
	if (Z_TYPE_P(message) == IS_ARRAY) {
		...
		ZVAL_LONG(&_1$$3, 1);
		ZEPHIR_CALL_FUNCTION(&values, "array_slice", NULL, 94, message, &_1$$3);
		zephir_check_call_status();
		ZEPHIR_OBS_VAR(str);
	...
	if (zephir_is_true(_2)) {
		...
		if (zephir_fast_count_int(_8$$6 TSRMLS_CC)) {
			ZEPHIR_CALL_FUNCTION(&message, "strtr", NULL, 86, str, values);
			zephir_check_call_status();
		} else {
...
PHP_METHOD(Ice_Exception, errorHandler) {
	...
	if (((int) (zephir_get_numberval(_0)) & code)) {
		...
		ZVAL_LONG(_4$$3, line);
		ZEPHIR_CALL_METHOD(NULL, _1$$3, "__construct", NULL, 96, message, _2$$3, _3$$3, file, _4$$3);
		zephir_check_call_status();
...
PHP_METHOD(Ice_Exception, shutdownHandler) {
	...
	if (_0) {
		...
		ZVAL_LONG(_9$$3, 0);
		ZEPHIR_CALL_METHOD(NULL, _4$$3, "__construct", NULL, 96, _5$$3, _6$$3, _9$$3, _7$$3, _8$$3);
		zephir_check_call_status();
