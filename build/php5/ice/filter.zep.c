	...
	do {
		...
		if (ZEPHIR_IS_STRING(filter, "lower")) {
			...
			if ((zephir_function_exists_ex(SS("mb_strtolower") TSRMLS_CC) == SUCCESS)) {
				ZEPHIR_CALL_FUNCTION(&_17$$10, "mb_strtolower", NULL, 105, value);
				zephir_check_call_status();
			} else {
		...
		if (ZEPHIR_IS_STRING(filter, "upper")) {
			...
			if ((zephir_function_exists_ex(SS("mb_strtoupper") TSRMLS_CC) == SUCCESS)) {
				ZEPHIR_CALL_FUNCTION(&_18$$11, "mb_strtoupper", NULL, 106, value);
				zephir_check_call_status();
			} else {
		...
		if (ZEPHIR_IS_STRING(filter, "alnum")) {
			...
			ZEPHIR_RETURN_CALL_FUNCTION("preg_replace", &_14, 104, _19$$12, _20$$12, value);
		...
		if (ZEPHIR_IS_STRING(filter, "alpha")) {
			...
			ZEPHIR_RETURN_CALL_FUNCTION("preg_replace", &_14, 104, _21$$13, _22$$13, value);
		...
		if (ZEPHIR_IS_STRING(filter, "email")) {
			...
			ZEPHIR_RETURN_CALL_FUNCTION("filter_var", &_24, 107, value, &_23$$14);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(filter, "bool") || ZEPHIR_IS_STRING(filter, "boolean")) {
			...
			ZEPHIR_RETURN_CALL_FUNCTION("filter_var", &_24, 107, value, &_25$$15);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(filter, "float")) {
			...
			ZEPHIR_CALL_FUNCTION(&_28$$16, "filter_var", &_24, 107, value, &_26$$16, &_27$$16);
			zephir_check_call_status();
		...
		if (ZEPHIR_IS_STRING(filter, "int") || ZEPHIR_IS_STRING(filter, "integer")) {
			...
			ZEPHIR_CALL_FUNCTION(&_30$$17, "filter_var", &_24, 107, value, &_29$$17);
			zephir_check_call_status();
		...
		if (ZEPHIR_IS_STRING(filter, "string")) {
			...
			ZEPHIR_RETURN_CALL_FUNCTION("filter_var", &_24, 107, value, &_31$$18);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(filter, "repeats") || ZEPHIR_IS_STRING(filter, "strip_repeats")) {
			...
			ZEPHIR_RETURN_CALL_FUNCTION("preg_replace", &_14, 104, _32$$19, _34$$19, value);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(filter, "e") || ZEPHIR_IS_STRING(filter, "escape") || ZEPHIR_IS_STRING(filter, "strip_special")) {
			...
			ZEPHIR_RETURN_CALL_FUNCTION("htmlspecialchars", NULL, 108, _38$$20, &_39$$20);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(filter, "unescape") || ZEPHIR_IS_STRING(filter, "unstrip_special")) {
			...
			ZEPHIR_RETURN_CALL_FUNCTION("htmlspecialchars_decode", NULL, 109, value, &_40$$21);
			zephir_check_call_status();
			RETURN_MM();
		}
