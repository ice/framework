...
PHP_METHOD(Ice_Loader, register) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "spl_autoload_register", NULL, 155, _0);
...
PHP_METHOD(Ice_Loader, addNamespace) {
	...
	if (!(zephir_array_isset(_9, prefix))) {
		...
		ZEPHIR_CALL_FUNCTION(&_11$$3, "utf8_encode", &_12, 156, baseDir);
		zephir_check_call_status();
	...
	if (prepend) {
		...
		ZEPHIR_CALL_FUNCTION(&_18$$5, "utf8_encode", &_12, 156, baseDir);
		zephir_check_call_status();
		ZEPHIR_MAKE_REF(_17$$5);
		ZEPHIR_CALL_FUNCTION(NULL, "array_push", NULL, 157, _17$$5, _18$$5);
		ZEPHIR_UNREF(_17$$5);
		zephir_check_call_status();
	}
	RETURN_THIS();
...
PHP_METHOD(Ice_Loader, loadClass) {
	...
	ZEPHIR_SINIT_VAR(_0);
	ZVAL_STRING(&_0, "\\", 0);
	ZEPHIR_CALL_FUNCTION(&pos, "strrpos", &_1, 158, prefix, &_0);
	zephir_check_call_status();
	if (ZEPHIR_IS_FALSE_IDENTICAL(pos)) {
		...
		do {
			...
			ZVAL_STRING(&_9$$6, "\\", 0);
			ZEPHIR_CALL_FUNCTION(&pos, "strrpos", &_1, 158, prefix, &_9$$6);
			zephir_check_call_status();
