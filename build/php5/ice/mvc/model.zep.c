...
PHP_METHOD(Ice_Mvc_Model, update) {
	...
	HashPosition _2$$3;
	zend_bool _19;
	zval *_16, *_33, *_36, *_45;
	zephir_fcall_cache_entry *_6 = NULL, *_11 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *fields = NULL, *extra = NULL, *data = NULL, *status = NULL, *primary = NULL, *key = NULL, *_0, *_10 = NULL, *_15, *_17 = NULL, *_18, *_20, *_32, *_34, *_35, *_37 = NULL, *_38, *_39, *_41, *_42, *_44, *_1$$3, **_4$$3, *_5$$4 = NULL, *_7$$5, *_8$$5 = NULL, *_9$$5, *_12$$6 = NULL, *_13$$6 = NULL, *_14$$7, *_21$$8, *_22$$8 = NULL, *_23$$8, *_24$$8 = NULL, *_25$$8, *_26$$8 = NULL, *_27$$9, *_28$$9, *_29$$9, *_30$$9 = NULL, *_31$$9 = NULL, *_40$$11 = NULL, *_43$$13;
	...
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(_38);
	zephir_read_property_this(&_38, this_ptr, SL("autoincrement"), PH_NOISY_CC);
	ZEPHIR_INIT_NVAR(_17);
	ZVAL_BOOL(_17, !zephir_is_true(_38));
	ZEPHIR_CALL_METHOD(&fields, this_ptr, "fields", &_11, 0, _37, _17);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(_39);
	zephir_read_property_this(&_39, this_ptr, SL("primary"), PH_NOISY_CC);
	if (Z_TYPE_P(_39) == IS_ARRAY) {
		ZEPHIR_CALL_FUNCTION(&_40$$11, "array_diff_key", NULL, 12, fields, primary);
		zephir_check_call_status();
		ZEPHIR_CPY_WRT(fields, _40$$11);
	}
	_41 = zephir_fetch_nproperty_this(this_ptr, SL("db"), PH_NOISY_CC);
	_42 = zephir_fetch_nproperty_this(this_ptr, SL("from"), PH_NOISY_CC);
	ZEPHIR_CALL_METHOD(&status, _41, "update", NULL, 0, _42, primary, fields);
	zephir_check_call_status();
	if (!(zephir_is_true(status))) {
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "setdata", NULL, 0, data);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_VAR(_43$$13);
		zephir_fast_array_merge(_43$$13, &(data), &(fields) TSRMLS_CC);
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "setdata", NULL, 0, _43$$13);
		zephir_check_call_status();
	}
	_44 = zephir_fetch_nproperty_this(this_ptr, SL("di"), PH_NOISY_CC);
	ZEPHIR_INIT_VAR(_45);
	zephir_create_array(_45, 1, 0 TSRMLS_CC);
	zephir_array_fast_append(_45, this_ptr);
	ZEPHIR_INIT_NVAR(_17);
	ZVAL_STRING(_17, "model.after.update", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_CALL_METHOD(NULL, _44, "applyhook", NULL, 0, _17, _45, this_ptr);
	zephir_check_temp_parameter(_17);
	zephir_check_call_status();
	RETURN_CCTOR(status);
...
PHP_METHOD(Ice_Mvc_Model, exists) {
	...
	if (!(zephir_is_true(filters))) {
		...
		if (Z_TYPE_P(_3$$4) == IS_ARRAY) {
			...
			zephir_is_iterable(_4$$5, &_6$$5, &_5$$5, 0, 0, "ice/mvc/model.zep", 528);
			for (
...
PHP_METHOD(Ice_Mvc_Model, getRelated) {
	...
	if (!(zephir_array_isset_fetch(&relation, _0, alias, 0 TSRMLS_CC))) {
		...
		ZEPHIR_CALL_FUNCTION(&_3$$3, "sprintf", NULL, 13, &_2$$3, alias);
		zephir_check_call_status();
...
PHP_METHOD(Ice_Mvc_Model, getRules) {
	...
	if (zephir_is_true(fields)) {
		...
		if (Z_TYPE_P(fields) == IS_ARRAY) {
			...
			array_init(rules);
			zephir_is_iterable(fields, &_3$$4, &_2$$4, 0, 0, "ice/mvc/model.zep", 746);
			for (
			  ; zend_hash_get_current_data_ex(_3$$4, (void**) &_4$$4, &_2$$4) == SUCCESS
			  ; zend_hash_move_forward_ex(_3$$4, &_2$$4)
			) {
				...
				if (zephir_array_isset(_5$$5, field)) {
					...
					zephir_array_fetch(&_7$$6, _6$$6, field, PH_NOISY | PH_READONLY, "ice/mvc/model.zep", 742 TSRMLS_CC);
			...
			zephir_array_fetch(&_9$$7, _8$$7, fields, PH_NOISY | PH_READONLY, "ice/mvc/model.zep", 748 TSRMLS_CC);
			RETURN_CTOR(_9$$7);
		}
		RETURN_MM_NULL();
	}
...
PHP_METHOD(Ice_Mvc_Model, serialize) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "serialize", NULL, 15, _0);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("base64_encode", NULL, 16, _1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Ice_Mvc_Model, unserialize) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_0, "base64_decode", NULL, 17, serialized);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_1, "unserialize", NULL, 18, _0);
	zephir_check_call_status();
...
PHP_METHOD(Ice_Mvc_Model, __call) {
	...
	ZEPHIR_CALL_FUNCTION(&_5, "sprintf", NULL, 13, &_4, method);
	zephir_check_call_status();
