...
PHP_METHOD(Ice_Mvc_Route, __construct) {
	...
	if (ZEPHIR_IS_EMPTY(method)) {
		...
		if (Z_TYPE_P(method) == IS_ARRAY) {
			...
			ZEPHIR_CALL_FUNCTION(&_2$$7, "array_map", NULL, 51, &_1$$7, method);
	...
	ZEPHIR_CALL_FUNCTION(&regex, "preg_replace", NULL, 94, _4, _6, _5);
...
PHP_METHOD(Ice_Mvc_Route, matches) {
	...
	ZEPHIR_INIT_VAR(_1);
	_2 = zephir_fetch_nproperty_this(this_ptr, SL("routeRegex"), PH_NOISY_CC);
	zephir_preg_match(_1, _2, uri, matches, 0, 0 , 0  TSRMLS_CC);
...
PHP_METHOD(Ice_Mvc_Route, uri) {
	...
	zend_bool _3;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *params_param = NULL, *defaults = NULL, *uri = NULL, *param = NULL, *search = NULL, *key = NULL, *replace = NULL, *matches = NULL, *_0, _1, *_2, _4, *_5, *_7 = NULL, _8 = zval_used_for_init, *_16 = NULL, *_21, _22, *_23, *_24, *_6$$4, _9$$5 = zval_used_for_init, _10$$5 = zval_used_for_init, *_11$$5 = NULL, *_15$$5 = NULL, *_13$$7 = NULL, *_14$$7, *_18$$10 = NULL, *_19$$9 = NULL, *_20$$9;
	zval *params = NULL;
	...
	while (1) {
		...
		ZVAL_STRING(&_8, "#\\[[^[\\]]++\\]#", 0);
		zephir_preg_match(_7, &_8, uri, matches, 0, 0 , 0  TSRMLS_CC);
		...
		while (1) {
			...
			zephir_preg_match(_11$$5, _12$$5, replace, matches, 0, 0 , 0  TSRMLS_CC);
			...
			if (zephir_array_isset(defaults, param)) {
				...
				zephir_array_fetch(&_14$$7, defaults, param, PH_NOISY | PH_READONLY, "ice/mvc/route.zep", 230 TSRMLS_CC);
				zephir_fast_str_replace(&_13$$7, key, _14$$7, replace TSRMLS_CC);
				ZEPHIR_CPY_WRT(replace, _13$$7);
			} else {
				ZEPHIR_INIT_NVAR(replace);
		...
		zephir_fast_str_replace(&_15$$5, search, replace, uri TSRMLS_CC);
		ZEPHIR_CPY_WRT(uri, _15$$5);
	}
	while (1) {
		ZEPHIR_INIT_NVAR(_16);
		ZEPHIR_INIT_LNVAR(_17);
		ZEPHIR_CONCAT_SSS(_17, "#", "\\{([a-zA-Z0-9_]++)\\}", "#");
		zephir_preg_match(_16, _17, uri, matches, 0, 0 , 0  TSRMLS_CC);
		...
		if (!(zephir_array_isset(defaults, param))) {
			...
			ZEPHIR_CONCAT_SV(_18$$10, "Required route parameter not passed: ", param);
			zephir_update_property_this(getThis(), SL("error"), _18$$10 TSRMLS_CC);
			RETURN_MM_BOOL(0);
		}
		ZEPHIR_INIT_NVAR(_19$$9);
		zephir_array_fetch(&_20$$9, defaults, param, PH_NOISY | PH_READONLY, "ice/mvc/route.zep", 251 TSRMLS_CC);
		zephir_fast_str_replace(&_19$$9, key, _20$$9, uri TSRMLS_CC);
		ZEPHIR_CPY_WRT(uri, _19$$9);
	}
	ZEPHIR_INIT_VAR(_21);
	ZEPHIR_SINIT_VAR(_22);
	ZVAL_STRING(&_22, "/", 0);
	zephir_fast_trim(_21, uri, &_22, ZEPHIR_TRIM_RIGHT TSRMLS_CC);
	ZEPHIR_INIT_VAR(_23);
	ZVAL_STRING(_23, "#//+#", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_INIT_VAR(_24);
	ZVAL_STRING(_24, "/", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_RETURN_CALL_FUNCTION("preg_replace", NULL, 94, _23, _24, _21);
