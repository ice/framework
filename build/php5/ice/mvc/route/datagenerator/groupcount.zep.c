...
PHP_METHOD(Ice_Mvc_Route_DataGenerator_GroupCount, processChunk) {
	...
	for (
	  ...
	  ; zend_hash_move_forward_ex(_1, &_0)
		...
		ZEPHIR_CALL_FUNCTION(&_4$$3, "max", &_5, 48, numGroups, numVariables);
		...
		ZEPHIR_CALL_FUNCTION(&_4$$3, "str_repeat", &_9, 96, &_7$$3, &_8$$3);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_14, "utf8_encode", NULL, 152, regex);
	zephir_check_call_status();
