...
PHP_METHOD(Ice_Mvc_Route_DataGenerator_Regex, generateVariableRouteData) {
	...
	for (
	  ...
	  ; zend_hash_move_forward_ex(_2, &_1)
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&chunks, "array_chunk", &_6, 48, regexToRoutesMap, chunkSize, ZEPHIR_GLOBAL(global_true));
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_8$$3, "array_map", &_9, 49, _7$$3, chunks);
		zephir_check_call_status();
...
PHP_METHOD(Ice_Mvc_Route_DataGenerator_Regex, addStaticRoute) {
	...
	if (_1) {
		...
		ZEPHIR_CALL_FUNCTION(&_6$$3, "sprintf", &_7, 13, &_5$$3, routeStr, httpMethod);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, _4$$3, "__construct", &_8, 14, _6$$3);
		zephir_check_call_status();
		...
		for (
		  ...
		  ; zend_hash_move_forward_ex(_13$$4, &_12$$4)
			...
			if (zephir_is_true(_15$$5)) {
				...
				ZEPHIR_CALL_FUNCTION(&_19$$6, "sprintf", &_7, 13, &_18$$6, routeStr, _17$$6, httpMethod);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(NULL, _16$$6, "__construct", &_8, 14, _19$$6);
				zephir_check_call_status();
...
PHP_METHOD(Ice_Mvc_Route_DataGenerator_Regex, addVariableRoute) {
	...
	if (_4) {
		...
		ZEPHIR_CALL_FUNCTION(&_9$$3, "sprintf", NULL, 13, &_8$$3, regex, httpMethod);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, _7$$3, "__construct", NULL, 14, _9$$3);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, _10, "__construct", NULL, 51, httpMethod, handler, regex, variables);
	zephir_check_call_status();
	...
	for (
	  ...
	  ; zend_hash_move_forward_ex(_1, &_0)
		...
		if (Z_TYPE_P(part) == IS_STRING) {
			...
			ZVAL_STRING(&_3$$4, "~", 0);
			ZEPHIR_CALL_FUNCTION(&_4$$4, "preg_quote", &_5, 52, part, &_3$$4);
			zephir_check_call_status();
		...
		if (zephir_array_isset(variables, varName)) {
			...
			ZEPHIR_CALL_FUNCTION(&_8$$5, "sprintf", &_9, 13, &_7$$5, varName);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(NULL, _6$$5, "__construct", &_10, 14, _8$$5);
			zephir_check_call_status();
