...
PHP_METHOD(Ice_Mvc_Route_Parser_Std, parse) {
	...
	ZEPHIR_CALL_FUNCTION(&segments, "preg_split", NULL, 137, _1, routeWithoutClosingOptionals);
	...
	for (
	  ...
	  ; zend_hash_move_forward_ex(_6, &_5)
		...
		ZEPHIR_CALL_METHOD(&_9$$5, this_ptr, "parseplaceholders", &_10, 138, currentRoute);
		zephir_check_call_status();
...
PHP_METHOD(Ice_Mvc_Route_Parser_Std, parsePlaceholders) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "preg_match_all", NULL, 139, _0, route, matches, _1);
