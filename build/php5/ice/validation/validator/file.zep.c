...
PHP_METHOD(Ice_Validation_Validator_File, validate) {
	...
	if (!(_32)) {
		...
		ZEPHIR_CALL_FUNCTION(&_34, "is_uploaded_file", NULL, 164, _33);
		zephir_check_call_status();
	...
	if (zephir_is_true(_61)) {
		...
		ZEPHIR_CALL_FUNCTION(&_67$$18, "floatval", &_68, 165, _66$$18);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_67$$18, "floatval", &_68, 165, _72$$18);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_73$$18, "floatval", &_68, 165, bytes);
		zephir_check_call_status();
	...
	if (zephir_is_true(_86)) {
		...
		if ((zephir_function_exists_ex(SS("finfo_open") TSRMLS_CC) == SUCCESS)) {
			...
			ZVAL_LONG(&_88$$26, 16);
			ZEPHIR_CALL_FUNCTION(&tmp, "finfo_open", NULL, 166, &_88$$26);
			zephir_check_call_status();
			zephir_array_fetch_string(&_89$$26, value, SL("tmp_name"), PH_NOISY | PH_READONLY, "ice/validation/validator/file.zep", 171 TSRMLS_CC);
			ZEPHIR_CALL_FUNCTION(&mime, "finfo_file", NULL, 167, tmp, _89$$26);
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(NULL, "finfo_close", NULL, 168, tmp);
			zephir_check_call_status();
		} else {
	...
	if (_103) {
		...
		ZEPHIR_CALL_FUNCTION(&tmp, "getimagesize", NULL, 169, _105$$32);
		zephir_check_call_status();
