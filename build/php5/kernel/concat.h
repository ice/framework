...
#define ZEPHIR_CONCAT_SVVSVSVS(result, op1, op2, op3, op4, op5, op6, op7, op8) \
	 zephir_concat_svvsvsvs(&result, op1, sizeof(op1)-1, op2, op3, op4, sizeof(op4)-1, op5, op6, sizeof(op6)-1, op7, op8, sizeof(op8)-1, 0 TSRMLS_CC);
#define ZEPHIR_SCONCAT_SVVSVSVS(result, op1, op2, op3, op4, op5, op6, op7, op8) \
	 zephir_concat_svvsvsvs(&result, op1, sizeof(op1)-1, op2, op3, op4, sizeof(op4)-1, op5, op6, sizeof(op6)-1, op7, op8, sizeof(op8)-1, 1 TSRMLS_CC);
