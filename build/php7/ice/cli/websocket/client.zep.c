...
PHP_METHOD(Ice_Cli_Websocket_Client, connect) {
	...
	zval _5, _13;
	zend_bool _0, _1, _3;
	zephir_fcall_cache_entry *_17 = NULL, *_38 = NULL, *_41 = NULL, *_43 = NULL, *_54 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *address_param = NULL, *headers = NULL, headers_sub, addr, key, name, value, res, data, matches, _2, _4, _6, _7, _8, _9, _10, _11, _12, _14, _15, _16, _18, *_19, _23, _28, _29, _30, _31, _32, _33, _34, _35, _36, _37, _39, _40, _42, _22$$5, _24$$6, _25$$6, _26$$6, _27$$6, _44$$9, _45$$9, _46$$9, _47$$9, _48$$9, _49$$9, _50$$9, _51$$9, _52$$9, _53$$9;
	zval address;
	...
	ZEPHIR_CALL_FUNCTION(&addr, "parse_url", NULL, 66, &address);
	...
	ZEPHIR_CALL_FUNCTION(&_10, "fsockopen", NULL, 67, &_8, &_9);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(NULL, "array_unshift", NULL, 68, headers, &_16);
	...
	ZEPHIR_INIT_VAR(&_31);
	ZEPHIR_INIT_VAR(&_32);
	ZVAL_STRING(&_32, "(Sec-Websocket-Accept:\\s*(.*)$)mUi");
	zephir_preg_match(&_31, &_32, &data, &matches, 0, 0 , 0  TSRMLS_CC);
	if (!(zephir_is_true(&_31))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(ice_exception_ce, "Bad response", "ice/cli/websocket/client.zep", 78);
		return;
	}
	ZEPHIR_INIT_VAR(&_33);
	zephir_array_fetch_long(&_34, &matches, 1, PH_NOISY | PH_READONLY, "ice/cli/websocket/client.zep", 81 TSRMLS_CC);
	zephir_fast_trim(&_33, &_34, NULL , ZEPHIR_TRIM_BOTH TSRMLS_CC);
	ZEPHIR_OBS_VAR(&_35);
	zephir_read_static_property_ce(&_35, ice_cli_websocket_client_ce, SL("magic"), PH_NOISY_CC);
	ZEPHIR_INIT_VAR(&_36);
	ZEPHIR_CONCAT_VV(&_36, &key, &_35);
	ZEPHIR_CALL_FUNCTION(&_37, "sha1", &_38, 54, &_36);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_39);
	ZVAL_STRING(&_39, "H*");
	ZEPHIR_CALL_FUNCTION(&_40, "pack", &_41, 69, &_39, &_37);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_42, "base64_encode", &_43, 14, &_40);
	zephir_check_call_status();
	if (!ZEPHIR_IS_IDENTICAL(&_33, &_42)) {
		ZEPHIR_INIT_VAR(&_44$$9);
		object_init_ex(&_44$$9, ice_exception_ce);
		ZEPHIR_INIT_VAR(&_45$$9);
		zephir_array_fetch_long(&_46$$9, &matches, 1, PH_NOISY | PH_READONLY, "ice/cli/websocket/client.zep", 82 TSRMLS_CC);
		zephir_fast_trim(&_45$$9, &_46$$9, NULL , ZEPHIR_TRIM_BOTH TSRMLS_CC);
		ZEPHIR_OBS_VAR(&_47$$9);
		zephir_read_static_property_ce(&_47$$9, ice_cli_websocket_client_ce, SL("magic"), PH_NOISY_CC);
		ZEPHIR_INIT_VAR(&_48$$9);
		ZEPHIR_CONCAT_VV(&_48$$9, &key, &_47$$9);
		ZEPHIR_CALL_FUNCTION(&_49$$9, "sha1", &_38, 54, &_48$$9);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_50$$9);
		ZVAL_STRING(&_50$$9, "H*");
		ZEPHIR_CALL_FUNCTION(&_51$$9, "pack", &_41, 69, &_50$$9, &_49$$9);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_52$$9, "base64_encode", &_43, 14, &_51$$9);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_50$$9);
		ZVAL_STRING(&_50$$9, "Bad key `%s` `%s`");
		ZEPHIR_CALL_FUNCTION(&_53$$9, "sprintf", NULL, 11, &_50$$9, &_45$$9, &_52$$9);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_44$$9, "__construct", &_54, 12, &_53$$9);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_44$$9, "ice/cli/websocket/client.zep", 82 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	RETURN_THIS();
...
PHP_METHOD(Ice_Cli_Websocket_Client, normalizeHeaders) {
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&headers), _1, _2, _0)
	{
		...
		ZVAL_LONG(&_4$$3, 5);
		ZEPHIR_CALL_FUNCTION(&_5$$3, "strncmp", &_6, 70, &name, &_3$$3, &_4$$3);
		zephir_check_call_status();
		...
		if (!ZEPHIR_IS_FALSE_IDENTICAL(&name)) {
			...
			ZVAL_STRING(&_13$$5, "-");
			ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_14, 71, &_9$$5, &_13$$5);
			zephir_check_call_status();
...
PHP_METHOD(Ice_Cli_Websocket_Client, run) {
	...
	while (1) {
		...
		if (zephir_isset_property(this_ptr, SL("tick"))) {
			...
			ZEPHIR_CALL_FUNCTION(&_1$$4, "call_user_func", &_2, 72, &_0$$4, this_ptr);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_7$$3, "stream_select", &_8, 73, &changed, &_5$$3, &_6$$3, &_4$$3);
		...
		if (ZEPHIR_GT_LONG(&_7$$3, 0)) {
			...
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&changed), _9$$6)
			{
				...
				if (_11$$7) {
					...
					ZEPHIR_CALL_FUNCTION(NULL, "call_user_func", &_2, 72, &_12$$8, &message, this_ptr);
					zephir_check_call_status();
				}
			} ZEND_HASH_FOREACH_END();
			ZEPHIR_INIT_NVAR(&socket);
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(NULL, "usleep", &_16, 29, &_13$$3);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
