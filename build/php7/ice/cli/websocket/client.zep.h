...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_ice_cli_websocket_client_connect, 0, 0, NULL, "Ice\\Cli\\Websocket\\self", 0)
#endif
...
#ifdef ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_ice_cli_websocket_client_normalizeheaders, 0, 1, IS_NULL, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_ice_cli_websocket_client_normalizeheaders, 0, 1, IS_NULL, NULL, 0)
#endif
...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_ice_cli_websocket_client_onmessage, 0, 1, NULL, "Ice\\Cli\\Websocket\\self", 0)
#endif
...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_ice_cli_websocket_client_ontick, 0, 1, NULL, "Ice\\Cli\\Websocket\\self", 0)
#endif
	ZEND_ARG_INFO(0, callback)
ZEND_END_ARG_INFO()
