...
PHP_METHOD(Ice_Crypt, generateInputVector) {
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("openssl_random_pseudo_bytes", NULL, 58, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Ice_Crypt, doEncrypt) {
	...
	ZVAL_LONG(&_4, 1);
	ZEPHIR_RETURN_CALL_FUNCTION("openssl_encrypt", NULL, 83, &value, &_2, &_3, &_4, &iv);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Ice_Crypt, doDecrypt) {
	...
	zephir_read_property(&_3, this_ptr, SL("key"), PH_NOISY_CC | PH_READONLY);
	ZVAL_LONG(&_4, 1);
	ZEPHIR_RETURN_CALL_FUNCTION("openssl_decrypt", NULL, 84, &value, &_2, &_3, &_4, &iv);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Ice_Crypt, hash) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("hash_hmac", NULL, 24, &_1, &value, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Ice_Crypt, addPadding) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "chr", NULL, 36, &pad);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_4, "str_repeat", NULL, 85, &_3, &pad);
	zephir_check_call_status();
...
PHP_METHOD(Ice_Crypt, stripPadding) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "ord", NULL, 31, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Ice_Crypt, paddingIsValid) {
	...
	ZVAL_LONG(&_3, pad);
	ZEPHIR_CALL_FUNCTION(&_4, "str_repeat", NULL, 85, &_2, &_3);
	zephir_check_call_status();
...
PHP_METHOD(Ice_Crypt, getIvSize) {
	...
	ZEPHIR_INIT_VAR(&_2);
	ZEPHIR_CONCAT_VSV(&_2, &_0, "-", &_1);
	ZEPHIR_RETURN_CALL_FUNCTION("openssl_cipher_iv_length", NULL, 86, &_2);
	zephir_check_call_status();
	RETURN_MM();
