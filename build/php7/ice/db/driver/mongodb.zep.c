...
PHP_METHOD(Ice_Db_Driver_Mongodb, __construct) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "phpversion", NULL, 89, &_0);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "1.2.0alpha1");
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, ">=");
	ZEPHIR_CALL_FUNCTION(&_3, "version_compare", NULL, 90, &_1, &_0, &_2);
	zephir_check_call_status();
...
PHP_METHOD(Ice_Db_Driver_Mongodb, getDateTime) {
	...
	if (_0) {
		...
		do {
			...
			ZEPHIR_CALL_FUNCTION(&_3$$7, "strtotime", NULL, 60, value);
			zephir_check_call_status();
...
PHP_METHOD(Ice_Db_Driver_Mongodb, findOne) {
	...
	if (zephir_fast_count_int(&result TSRMLS_CC)) {
		...
		ZEPHIR_CALL_FUNCTION(&_2, "current", NULL, 91, &result);
		zephir_check_call_status();
...
PHP_METHOD(Ice_Db_Driver_Mongodb, select) {
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("iterator_to_array", NULL, 92, &result);
	zephir_check_call_status();
	RETURN_MM();
