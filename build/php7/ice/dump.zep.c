...
PHP_METHOD(Ice_Dump, output) {
	...
	if (Z_TYPE_P(variable) == IS_ARRAY) {
		...
		ZEPHIR_CALL_FUNCTION(&_5$$4, "strtr", &_8, 102, &_0$$4, &_4$$4);
		zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(variable), _10$$4, _11$$4, _9$$4)
		{
			...
			ZEPHIR_CALL_FUNCTION(&_17$$5, "strtr", &_8, 102, &_14$$5, &_16$$5);
			zephir_check_call_status();
			...
			if (_22$$5) {
				...
				ZEPHIR_CALL_METHOD(&_23$$7, this_ptr, "output", &_26, 103, &value, &_24$$7, &_25$$7);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_24$$7);
	...
	if (Z_TYPE_P(variable) == IS_OBJECT) {
		...
		ZEPHIR_CALL_FUNCTION(&_33$$8, "strtr", &_8, 102, &_30$$8, &_32$$8);
		zephir_check_call_status();
		zephir_concat_self(&output, &_33$$8 TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_35$$8, "get_parent_class", &_36, 104, variable);
		zephir_check_call_status();
		if (zephir_is_true(&_35$$8)) {
			...
			ZEPHIR_CALL_FUNCTION(&_40$$9, "get_parent_class", &_36, 104, variable);
			zephir_check_call_status();
			zephir_array_update_string(&_39$$9, SL(":parent"), &_40$$9, PH_COPY | PH_SEPARATE);
			ZEPHIR_CALL_FUNCTION(&_40$$9, "strtr", &_8, 102, &_37$$9, &_39$$9);
			zephir_check_call_status();
		...
		if (zephir_fast_in_array(&className$$8, &_43$$8 TSRMLS_CC)) {
			...
			ZEPHIR_CALL_FUNCTION(&_48$$11, "get_object_vars", NULL, 105, variable);
			zephir_check_call_status();
			...
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_48$$11), _50$$11, _51$$11, _49$$11)
			{
				...
				ZEPHIR_CALL_FUNCTION(&_56$$12, "strtr", &_8, 102, &_53$$12, &_55$$12);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_59$$12, this_ptr, "output", &_26, 103, &value, &_57$$12, &_60$$12);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_57$$12);
			...
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_65$$13), _66$$13)
			{
				...
				ZEPHIR_CALL_FUNCTION(&_75$$14, "strtr", &_8, 102, &_72$$14, &_74$$14);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_78$$14, this_ptr, "output", &_26, 103, &value, &_76$$14, &_79$$14);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_76$$14);
		...
		ZEPHIR_CALL_FUNCTION(&attr, "get_class_methods", NULL, 106, variable);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_87$$8, "strtr", &_8, 102, &_82$$8, &_86$$8);
		zephir_check_call_status();
		...
		if (zephir_fast_in_array(&className$$8, &_90$$8 TSRMLS_CC)) {
			...
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attr), _94$$18)
			{
				...
				if (ZEPHIR_IS_STRING(&value, "__construct")) {
					...
					ZEPHIR_CALL_FUNCTION(&_102$$21, "strtr", &_8, 102, &_98$$21, &_101$$21);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_111$$22, "strtr", &_8, 102, &_107$$22, &_110$$22);
					zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_LONG) {
		...
		ZEPHIR_CALL_FUNCTION(&_122$$23, "strtr", &_8, 102, &_119$$23, &_121$$23);
		zephir_check_call_status();
		ZEPHIR_CONCAT_VV(return_value, &output, &_122$$23);
		RETURN_MM();
	}
	ZEPHIR_CALL_FUNCTION(&_124, "is_float", NULL, 107, variable);
	zephir_check_call_status();
	if (zephir_is_true(&_124)) {
		...
		ZEPHIR_CALL_FUNCTION(&_128$$24, "strtr", &_8, 102, &_125$$24, &_127$$24);
		zephir_check_call_status();
	...
	if (zephir_is_numeric(variable)) {
		...
		ZEPHIR_CALL_FUNCTION(&_133$$25, "strtr", &_8, 102, &_130$$25, &_132$$25);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_STRING) {
		...
		ZEPHIR_CALL_FUNCTION(&_138$$26, "htmlentities", NULL, 108, variable, &_140$$26, &_139$$26);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_141$$26, "nl2br", NULL, 109, &_138$$26);
		zephir_check_call_status();
		zephir_array_update_string(&_137$$26, SL(":var"), &_141$$26, PH_COPY | PH_SEPARATE);
		ZEPHIR_CALL_FUNCTION(&_141$$26, "strtr", &_8, 102, &_135$$26, &_137$$26);
		zephir_check_call_status();
	...
	if ((Z_TYPE_P(variable) == IS_TRUE || Z_TYPE_P(variable) == IS_FALSE)) {
		...
		ZEPHIR_CALL_FUNCTION(&_145$$27, "strtr", &_8, 102, &_142$$27, &_144$$27);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_NULL) {
		...
		ZEPHIR_CALL_FUNCTION(&_151$$28, "strtr", &_8, 102, &_148$$28, &_150$$28);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_156, "strtr", &_8, 102, &_153, &_155);
	zephir_check_call_status();
...
PHP_METHOD(Ice_Dump, variable) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("strtr", NULL, 102, &_0, &_2);
	zephir_check_call_status();
	RETURN_MM();
