...
PHP_METHOD(Ice_Http_Response, send) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "headers_sent", NULL, 122);
	zephir_check_call_status();
	if (!(zephir_is_true(&_0))) {
		...
		if (ZEPHIR_IS_LONG_IDENTICAL(&_3$$3, 0)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(NULL, "header", &_11, 123, &_9$$4);
			zephir_check_call_status();
		} else {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(NULL, "header", &_11, 123, &_17$$5);
			zephir_check_call_status();
		}
...
PHP_METHOD(Ice_Http_Response, sendFile) {
	...
	if (ZEPHIR_IS_EMPTY(&_0)) {
		...
		ZEPHIR_CALL_FUNCTION(&file, "tmpfile", NULL, 124);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&filepath, "realpath", NULL, 125, &_3$$4);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&size, "filesize", NULL, 126, &filepath);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_4$$4);
		ZVAL_STRING(&_4$$4, "rb");
		ZEPHIR_CALL_FUNCTION(&file, "fopen", NULL, 127, &filepath, &_4$$4);
		zephir_check_call_status();
	...
	if (ZEPHIR_IS_EMPTY(&_9)) {
		...
		if (ZEPHIR_IS_LONG(&_12$$9, 416)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(NULL, "header", NULL, 123, &_18$$10);
			zephir_check_call_status();
			ZEPHIR_MM_RESTORE();
			zephir_exit_empty();
		}
	...
	zephir_check_call_status();
	while (1) {
		ZEPHIR_CALL_FUNCTION(&_34, "ob_get_level", &_35, 115);
		zephir_check_call_status();
		if (!(zephir_is_true(&_34))) {
			break;
		}
		ZEPHIR_CALL_FUNCTION(NULL, "ob_end_flush", &_36, 128);
		zephir_check_call_status();
	}
	ZEPHIR_CALL_FUNCTION(NULL, "ignore_user_abort", NULL, 129, &__$true);
	zephir_check_call_status();
	...
	if (ZEPHIR_IS_EMPTY(&_37)) {
		ZVAL_LONG(&_38$$13, 0);
		ZEPHIR_CALL_FUNCTION(NULL, "set_time_limit", &_39, 130, &_38$$13);
		zephir_check_call_status();
	} else {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "set_time_limit", &_39, 130, &_41$$14);
		zephir_check_call_status();
	}
	block = 16384;
	...
	ZEPHIR_CALL_FUNCTION(NULL, "fseek", NULL, 131, &file, &start);
	zephir_check_call_status();
	while (1) {
		if (!(!(zephir_feof(&file TSRMLS_CC)))) {
			break;
		}
		ZEPHIR_CALL_FUNCTION(&pos, "ftell", &_44, 132, &file);
		zephir_check_call_status();
		_45$$17 = ZEPHIR_GT(&pos, &end);
		if (!(_45$$17)) {
			ZEPHIR_CALL_FUNCTION(&_46$$17, "connection_aborted", &_47, 133);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "flush", &_52, 134);
		zephir_check_call_status();
		if (speed > 0) {
	...
	if (zephir_is_true(&isDelete)) {
		...
		/* try_start_1: */
			...
			ZEPHIR_CALL_FUNCTION(NULL, "unlink", NULL, 135, &filepath);
	...
	if (zephir_array_isset_string(_SERVER, SL("HTTP_RANGE"))) {
		...
		if (!ZEPHIR_IS_STRING(&_1$$3, "bytes")) {
			...
			if (ZEPHIR_IS_STRING(&_4$$5, "-")) {
				...
				ZEPHIR_CALL_FUNCTION(&_6$$6, "abs", &_7, 136, &_5$$6);
				zephir_check_call_status();
				ZVAL_LONG(&_5$$6, (size - zephir_get_numberval(&_6$$6)));
				ZEPHIR_CALL_FUNCTION(&start, "abs", &_7, 136, &_5$$6);
				zephir_check_call_status();
			} else {
				...
				ZEPHIR_CALL_FUNCTION(&start, "abs", &_7, 136, &_10$$7);
				zephir_check_call_status();
