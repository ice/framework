...
PHP_METHOD(Ice_I18n, get) {
	...
	ZEPHIR_CALL_METHOD(&messages, this_ptr, "load", NULL, 139, &lang);
	...
	if (zephir_array_isset(&messages, &str)) {
		...
		if (Z_TYPE_P(&translation) == IS_ARRAY) {
			...
			ZEPHIR_RETURN_CALL_FUNCTION("reset", NULL, 140, &translation);
...
PHP_METHOD(Ice_I18n, pluralRules) {
	...
	ZVAL_STRING(&_1, "sk");
	zephir_array_fast_append(&_0, &_1);
	ZEPHIR_CALL_FUNCTION(&_2, "in_array", NULL, 141, &code, &_0, &__$true);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_3);
	...
	ZVAL_STRING(&_1, "bs");
	zephir_array_fast_append(&_3, &_1);
	ZEPHIR_CALL_FUNCTION(&_4, "in_array", NULL, 141, &code, &_3, &__$true);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_5);
	...
	ZVAL_STRING(&_1, "kab");
	zephir_array_fast_append(&_5, &_1);
	ZEPHIR_CALL_FUNCTION(&_6, "in_array", NULL, 141, &code, &_5, &__$true);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_7);
	...
	ZVAL_STRING(&_1, "ro");
	zephir_array_fast_append(&_7, &_1);
	ZEPHIR_CALL_FUNCTION(&_8, "in_array", NULL, 141, &code, &_7, &__$true);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_9);
	...
	ZVAL_STRING(&_1, "nso");
	zephir_array_fast_append(&_9, &_1);
	ZEPHIR_CALL_FUNCTION(&_10, "in_array", NULL, 141, &code, &_9, &__$true);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_11);
	...
	ZVAL_STRING(&_1, "ckb");
	zephir_array_fast_append(&_11, &_1);
	ZEPHIR_CALL_FUNCTION(&_12, "in_array", NULL, 141, &code, &_11, &__$true);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_13);
	...
	ZVAL_STRING(&_1, "smi");
	zephir_array_fast_append(&_13, &_1);
	ZEPHIR_CALL_FUNCTION(&_14, "in_array", NULL, 141, &code, &_13, &__$true);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_15);
	...
	ZVAL_STRING(&_1, "kea");
	zephir_array_fast_append(&_15, &_1);
	ZEPHIR_CALL_FUNCTION(&_16, "in_array", NULL, 141, &code, &_15, &__$true);
	zephir_check_call_status();
...
PHP_METHOD(Ice_I18n, translate) {
	...
	if (!(zephir_fast_count_int(&values TSRMLS_CC))) {
		...
		if (zephir_fast_count_int(&_7$$7 TSRMLS_CC)) {
			ZEPHIR_RETURN_CALL_FUNCTION("strtr", NULL, 105, &str, &values);
			zephir_check_call_status();
			RETURN_MM();
		} else {
