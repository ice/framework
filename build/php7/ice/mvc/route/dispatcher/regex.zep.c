...
PHP_METHOD(Ice_Mvc_Route_Dispatcher_Regex, setData) {
	...
	zephir_array_fetch_long(&_0, &data, 0, PH_NOISY | PH_READONLY, "ice/mvc/route/dispatcher/regex.zep", 15);
	zephir_update_property_zval(this_ptr, SL("staticRouteMap"), &_0);
	zephir_array_fetch_long(&_1, &data, 1, PH_NOISY | PH_READONLY, "ice/mvc/route/dispatcher/regex.zep", 16);
...
PHP_METHOD(Ice_Mvc_Route_Dispatcher_Regex, dispatch) {
	...
	if (_1) {
		...
		zephir_array_fetch(&_3, &_2, &httpMethod, PH_READONLY, "ice/mvc/route/dispatcher/regex.zep", 25);
		_1 = zephir_array_isset(&_3, &uri);
	}
	if (_1) {
		zephir_read_property(&_4$$3, this_ptr, SL("staticRouteMap"), PH_NOISY_CC | PH_READONLY);
		zephir_array_fetch(&_5$$3, &_4$$3, &httpMethod, PH_NOISY | PH_READONLY, "ice/mvc/route/dispatcher/regex.zep", 26);
		ZEPHIR_OBS_VAR(&handler);
		zephir_array_fetch(&handler, &_5$$3, &uri, PH_NOISY, "ice/mvc/route/dispatcher/regex.zep", 26);
	...
	if (zephir_array_isset(&varRouteData, &httpMethod)) {
		zephir_array_fetch(&_7$$4, &varRouteData, &httpMethod, PH_NOISY | PH_READONLY, "ice/mvc/route/dispatcher/regex.zep", 33);
		ZEPHIR_CALL_METHOD(&result, this_ptr, "dispatchvariableroute", &_8, 0, &_7$$4, &uri);
		zephir_check_call_status();
		zephir_array_fetch_long(&_9$$4, &result, 0, PH_NOISY | PH_READONLY, "ice/mvc/route/dispatcher/regex.zep", 35);
	...
	if (ZEPHIR_IS_STRING_IDENTICAL(&httpMethod, "HEAD")) {
		...
		zephir_array_fetch_string(&_11$$6, &_10$$6, SL("GET"), PH_READONLY, "ice/mvc/route/dispatcher/regex.zep", 42);
		if (zephir_array_isset(&_11$$6, &uri)) {
			zephir_read_property(&_12$$7, this_ptr, SL("staticRouteMap"), PH_NOISY_CC | PH_READONLY);
			zephir_array_fetch_string(&_13$$7, &_12$$7, SL("GET"), PH_NOISY | PH_READONLY, "ice/mvc/route/dispatcher/regex.zep", 43);
			ZEPHIR_OBS_NVAR(&handler);
			zephir_array_fetch(&handler, &_13$$7, &uri, PH_NOISY, "ice/mvc/route/dispatcher/regex.zep", 43);
			zephir_create_array(return_value, 3, 0);
		...
		if (zephir_array_isset_string(&varRouteData, SL("GET"))) {
			zephir_array_fetch_string(&_15$$8, &varRouteData, SL("GET"), PH_NOISY | PH_READONLY, "ice/mvc/route/dispatcher/regex.zep", 48);
			ZEPHIR_CALL_METHOD(&result, this_ptr, "dispatchvariableroute", &_8, 0, &_15$$8, &uri);
			zephir_check_call_status();
			zephir_array_fetch_long(&_16$$8, &result, 0, PH_NOISY | PH_READONLY, "ice/mvc/route/dispatcher/regex.zep", 50);
	...
	zephir_array_fetch_string(&_18, &_17, SL("*"), PH_READONLY, "ice/mvc/route/dispatcher/regex.zep", 57);
	if (zephir_array_isset(&_18, &uri)) {
		zephir_read_property(&_19$$10, this_ptr, SL("staticRouteMap"), PH_NOISY_CC | PH_READONLY);
		zephir_array_fetch_string(&_20$$10, &_19$$10, SL("*"), PH_NOISY | PH_READONLY, "ice/mvc/route/dispatcher/regex.zep", 58);
		ZEPHIR_OBS_NVAR(&handler);
		zephir_array_fetch(&handler, &_20$$10, &uri, PH_NOISY, "ice/mvc/route/dispatcher/regex.zep", 58);
		zephir_create_array(return_value, 3, 0);
	...
	if (zephir_array_isset_string(&varRouteData, SL("*"))) {
		zephir_array_fetch_string(&_22$$11, &varRouteData, SL("*"), PH_NOISY | PH_READONLY, "ice/mvc/route/dispatcher/regex.zep", 63);
		ZEPHIR_CALL_METHOD(&result, this_ptr, "dispatchvariableroute", &_8, 0, &_22$$11, &uri);
		zephir_check_call_status();
		zephir_array_fetch_long(&_23$$11, &result, 0, PH_NOISY | PH_READONLY, "ice/mvc/route/dispatcher/regex.zep", 65);
	...
	if (Z_TYPE_P(&varRouteData) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&varRouteData), _33, _34, _31)
		{
			...
			zephir_check_call_status();
			zephir_array_fetch_long(&_35$$17, &result, 0, PH_NOISY | PH_READONLY, "ice/mvc/route/dispatcher/regex.zep", 86);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&result, this_ptr, "dispatchvariableroute", &_8, 0, &routeData, &uri);
				zephir_check_call_status();
				zephir_array_fetch_long(&_36$$20, &result, 0, PH_NOISY | PH_READONLY, "ice/mvc/route/dispatcher/regex.zep", 86);
