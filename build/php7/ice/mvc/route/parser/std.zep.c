...
PHP_METHOD(Ice_Mvc_Route_Parser_Std, parse) {
	...
	ZEPHIR_CALL_FUNCTION(&segments, "preg_split", NULL, 149, &_1, &routeWithoutClosingOptionals);
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&segments), _6, _7, _5)
	{
		...
		ZEPHIR_CALL_METHOD(&_9$$5, this_ptr, "parseplaceholders", &_10, 150, &currentRoute);
		zephir_check_call_status();
...
PHP_METHOD(Ice_Mvc_Route_Parser_Std, parsePlaceholders) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "preg_match_all", NULL, 151, &_0, route, &matches, &_1);
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&matches), _3)
	{
		...
		ZVAL_COPY(&value, _3);
		zephir_array_fetch_long(&_4$$4, &value, 0, PH_NOISY | PH_READONLY, "ice/mvc/route/parser/std.zep", 68 TSRMLS_CC);
		zephir_array_fetch_long(&_5$$4, &_4$$4, 1, PH_NOISY | PH_READONLY, "ice/mvc/route/parser/std.zep", 68 TSRMLS_CC);
		if (ZEPHIR_GT(&_5$$4, &offset)) {
			zephir_array_fetch_long(&_6$$5, &value, 0, PH_NOISY | PH_READONLY, "ice/mvc/route/parser/std.zep", 69 TSRMLS_CC);
			zephir_array_fetch_long(&_7$$5, &_6$$5, 1, PH_NOISY | PH_READONLY, "ice/mvc/route/parser/std.zep", 69 TSRMLS_CC);
			ZEPHIR_SINIT_NVAR(_8$$5);
			zephir_sub_function(&_8$$5, &_7$$5, &offset);
			ZEPHIR_INIT_NVAR(&_9$$5);
			zephir_substr(&_9$$5, route, zephir_get_intval(&offset), zephir_get_intval(&_8$$5), 0);
			zephir_array_append(&routeData, &_9$$5, PH_SEPARATE, "ice/mvc/route/parser/std.zep", 69);
		}
		ZEPHIR_INIT_NVAR(&_10$$4);
		zephir_create_array(&_10$$4, 2, 0 TSRMLS_CC);
		zephir_array_fetch_long(&_11$$4, &value, 1, PH_NOISY | PH_READONLY, "ice/mvc/route/parser/std.zep", 73 TSRMLS_CC);
		ZEPHIR_OBS_NVAR(&_12$$4);
		zephir_array_fetch_long(&_12$$4, &_11$$4, 0, PH_NOISY, "ice/mvc/route/parser/std.zep", 73 TSRMLS_CC);
		zephir_array_fast_append(&_10$$4, &_12$$4);
		ZEPHIR_INIT_LNVAR(_13$$4);
		if (zephir_array_isset_long(&value, 2)) {
			zephir_array_fetch_long(&_14$$4, &value, 2, PH_NOISY | PH_READONLY, "ice/mvc/route/parser/std.zep", 74 TSRMLS_CC);
			zephir_array_fetch_long(&_15$$4, &_14$$4, 0, PH_NOISY | PH_READONLY, "ice/mvc/route/parser/std.zep", 74 TSRMLS_CC);
			ZEPHIR_INIT_NVAR(&_13$$4);
			zephir_fast_trim(&_13$$4, &_15$$4, NULL , ZEPHIR_TRIM_BOTH TSRMLS_CC);
		} else {
			ZEPHIR_INIT_NVAR(&_13$$4);
			ZVAL_STRING(&_13$$4, "[^/]+");
		}
		zephir_array_fast_append(&_10$$4, &_13$$4);
		zephir_array_append(&routeData, &_10$$4, PH_SEPARATE, "ice/mvc/route/parser/std.zep", 75);
		zephir_array_fetch_long(&_16$$4, &value, 0, PH_NOISY | PH_READONLY, "ice/mvc/route/parser/std.zep", 76 TSRMLS_CC);
		zephir_array_fetch_long(&_17$$4, &_16$$4, 1, PH_NOISY | PH_READONLY, "ice/mvc/route/parser/std.zep", 76 TSRMLS_CC);
		zephir_array_fetch_long(&_18$$4, &value, 0, PH_NOISY | PH_READONLY, "ice/mvc/route/parser/std.zep", 76 TSRMLS_CC);
		zephir_array_fetch_long(&_19$$4, &_18$$4, 0, PH_NOISY | PH_READONLY, "ice/mvc/route/parser/std.zep", 76 TSRMLS_CC);
		ZEPHIR_INIT_NVAR(&offset);
		ZVAL_LONG(&offset, (zephir_get_numberval(&_17$$4) + zephir_fast_strlen_ev(&_19$$4)));
	} ZEND_HASH_FOREACH_END();
	ZEPHIR_INIT_NVAR(&value);
