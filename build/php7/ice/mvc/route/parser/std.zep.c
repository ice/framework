...
PHP_METHOD(Ice_Mvc_Route_Parser_Std, parse) {
	...
	ZEPHIR_CALL_FUNCTION(&segments, "preg_split", NULL, 110, &_1, &routeWithoutClosingOptionals);
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&segments), _6, _7, _5)
	{
		...
		ZEPHIR_CALL_METHOD(&_9$$5, this_ptr, "parseplaceholders", &_10, 111, &currentRoute);
		zephir_check_call_status();
...
PHP_METHOD(Ice_Mvc_Route_Parser_Std, parsePlaceholders) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "preg_match_all", NULL, 112, &_0, route, &matches, &_1);
