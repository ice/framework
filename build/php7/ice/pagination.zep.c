...
PHP_METHOD(Ice_Pagination, calculate) {
	...
	ZVAL_LONG(&_8, limit);
	ZEPHIR_CALL_FUNCTION(&_9, "array_slice", NULL, 87, &data, &_7, &_8);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
...
PHP_METHOD(Ice_Pagination, floating) {
	...
	ZEPHIR_CALL_FUNCTION(&n2, "min", &_4, 141, &_3, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "pages");
	...
	ZEPHIR_CALL_FUNCTION(&n7, "max", &_7, 30, &_3, &_6);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "pages");
	...
	ZEPHIR_CALL_FUNCTION(&n4, "max", &_7, 30, &_3, &_6);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "current");
	...
	ZEPHIR_CALL_FUNCTION(&n5, "min", &_4, 141, &_3, &_6);
	zephir_check_call_status();
