...
PHP_METHOD(Ice_Pagination, calculate) {
	...
	ZVAL_LONG(&_4, 10);
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "get", NULL, 78, &_1, &_4);
	zephir_check_call_status();
	limit = zephir_get_intval(&_3);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "page");
	ZVAL_LONG(&_4, 1);
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "get", NULL, 78, &_1, &_4);
	zephir_check_call_status();
	...
	ZVAL_LONG(&_8, limit);
	ZEPHIR_CALL_FUNCTION(&_9, "array_slice", NULL, 97, &data, &_7, &_8);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
...
PHP_METHOD(Ice_Pagination, prepareButton) {
	...
	ZEPHIR_CALL_METHOD(&spanClass, this_ptr, "get", NULL, 78, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "aClass");
	ZEPHIR_CALL_METHOD(&aClass, this_ptr, "get", NULL, 78, &_1);
	zephir_check_call_status();
	if (!(active)) {
	...
	if (pages) {
		...
		ZEPHIR_CALL_METHOD(&_10$$10, this_ptr, "get", NULL, 78, page);
		zephir_check_call_status();
	...
	if (_12) {
		ZEPHIR_INIT_NVAR(&_1);
		ZVAL_STRING(&_1, "query");
		ZEPHIR_CALL_METHOD(&_13, this_ptr, "get", NULL, 78, &_1);
		zephir_check_call_status();
	...
	if (_12) {
		...
		ZEPHIR_CALL_METHOD(&_19$$11, this_ptr, "get", NULL, 78, &_20$$11);
		zephir_check_call_status();
...
PHP_METHOD(Ice_Pagination, minimal) {
	...
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "get", NULL, 78, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "previous");
	...
	ZEPHIR_CALL_METHOD(&_8, this_ptr, "get", NULL, 78, &_2);
	zephir_check_call_status();
	...
	if (ZEPHIR_GE_LONG(&_11, _10)) {
		while (1) {
			...
			ZEPHIR_CALL_METHOD(&_13$$3, this_ptr, "get", NULL, 78, &_14$$3);
			zephir_check_call_status();
			ZVAL_LONG(&_15$$3, i);
	...
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "current");
	ZEPHIR_CALL_METHOD(&_17, this_ptr, "get", NULL, 78, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "next");
	ZEPHIR_CALL_METHOD(&_18, this_ptr, "get", NULL, 78, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "next");
...
PHP_METHOD(Ice_Pagination, basic) {
	...
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "current");
	ZEPHIR_CALL_METHOD(&_9, this_ptr, "get", NULL, 78, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "previous");
	ZEPHIR_CALL_METHOD(&_10, this_ptr, "get", NULL, 78, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "previous");
	...
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "pages");
	ZEPHIR_CALL_METHOD(&_11, this_ptr, "get", NULL, 78, &_2);
	zephir_check_call_status();
	...
	if (ZEPHIR_GE_LONG(&_14, _13)) {
		while (1) {
			...
			ZEPHIR_CALL_METHOD(&_16$$3, this_ptr, "get", NULL, 78, &_17$$3);
			zephir_check_call_status();
			ZVAL_LONG(&_18$$3, i);
	...
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "current");
	ZEPHIR_CALL_METHOD(&_20, this_ptr, "get", NULL, 78, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "next");
	ZEPHIR_CALL_METHOD(&_21, this_ptr, "get", NULL, 78, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "next");
	...
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "current");
	ZEPHIR_CALL_METHOD(&_23, this_ptr, "get", NULL, 78, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "last");
	ZEPHIR_CALL_METHOD(&_24, this_ptr, "get", NULL, 78, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "last");
...
PHP_METHOD(Ice_Pagination, floating) {
	...
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "pages");
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "get", NULL, 78, &_1);
	zephir_check_call_status();
	ZVAL_LONG(&_3, countOut);
	ZEPHIR_CALL_FUNCTION(&n2, "min", &_4, 155, &_3, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "pages");
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "get", NULL, 78, &_1);
	zephir_check_call_status();
	ZVAL_LONG(&_3, 1);
	...
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "pages");
	ZEPHIR_CALL_METHOD(&n8, this_ptr, "get", NULL, 78, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "current");
	ZEPHIR_CALL_METHOD(&_8, this_ptr, "get", NULL, 78, &_1);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "current");
	ZEPHIR_CALL_METHOD(&_9, this_ptr, "get", NULL, 78, &_1);
	zephir_check_call_status();
	ZVAL_LONG(&_3, (zephir_get_numberval(&n7) - 1));
	ZVAL_LONG(&_6, (zephir_get_numberval(&_9) + countIn));
	ZEPHIR_CALL_FUNCTION(&n5, "min", &_4, 155, &_3, &_6);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "current");
	ZEPHIR_CALL_METHOD(&_32, this_ptr, "get", NULL, 78, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "first");
	ZEPHIR_CALL_METHOD(&_33, this_ptr, "get", NULL, 78, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "first");
	...
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "current");
	ZEPHIR_CALL_METHOD(&_36, this_ptr, "get", NULL, 78, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "previous");
	ZEPHIR_CALL_METHOD(&_37, this_ptr, "get", NULL, 78, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "previous");
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&links), _39, _40, _38)
	{
		...
		ZEPHIR_CALL_METHOD(&_42$$9, this_ptr, "get", NULL, 78, &_43$$9);
		zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "current");
	ZEPHIR_CALL_METHOD(&_46, this_ptr, "get", NULL, 78, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "next");
	ZEPHIR_CALL_METHOD(&_47, this_ptr, "get", NULL, 78, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "next");
	...
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "current");
	ZEPHIR_CALL_METHOD(&_49, this_ptr, "get", NULL, 78, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "last");
	ZEPHIR_CALL_METHOD(&_50, this_ptr, "get", NULL, 78, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "last");
