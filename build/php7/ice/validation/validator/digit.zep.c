...
PHP_METHOD(Ice_Validation_Validator_Digit, validate) {
	...
	zval field;
	zval *validation, validation_sub, *field_param = NULL, value, label, message, i18n, replace, _2, _3$$4, _4$$4, _6$$4, _9$$4, _11$$4, _12$$4, _16$$4, _5$$5, _7$$7, _8$$8, _13$$9, _14$$9, _15$$9;
	...
	if (!(_1)) {
		...
		ZEPHIR_CALL_FUNCTION(&_16$$4, "strtr", NULL, 102, &message, &replace);
		zephir_check_call_status();
