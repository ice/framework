...
PHP_METHOD(Ice_Validation_Validator_With, validate) {
	...
	zval field;
	zval *validation, validation_sub, *field_param = NULL, value, label, message, i18n, replace, fields, with, tmp, required, key, translate, _1, *_3, _2$$4, _5$$8, _6$$8, _8$$8, _11$$8, _13$$8, _14$$8, _23$$8, _7$$9, _9$$11, _10$$12, _15$$13, _16$$13, _17$$13, *_18$$13, _21$$14;
	...
	zephir_is_iterable(&fields, 0, "ice/validation/validator/with.zep", 75);
	...
	if (zephir_fast_count_int(&required TSRMLS_CC)) {
		...
		if (_12$$8) {
			...
			zephir_is_iterable(&required, 1, "ice/validation/validator/with.zep", 97);
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&required), _19$$13, _20$$13, _18$$13)
			{
				...
				zephir_check_call_status();
				zephir_array_update_zval(&required, &key, &_21$$14, PH_COPY | PH_SEPARATE);
			} ZEND_HASH_FOREACH_END();
			ZEPHIR_INIT_NVAR(&translate);
			ZEPHIR_INIT_NVAR(&key);
		}
		...
		ZEPHIR_INIT_NVAR(&_6$$8);
		zephir_fast_join_str(&_6$$8, SL(", "), &required TSRMLS_CC);
		zephir_array_update_string(&replace, SL(":fields"), &_6$$8, PH_COPY | PH_SEPARATE);
		ZEPHIR_CALL_FUNCTION(&_23$$8, "strtr", NULL, 102, &message, &replace);
		zephir_check_call_status();
