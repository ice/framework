...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_arr_getdata, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_arr_clear, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_arr_zephir_init_properties_ice_arr, 0, 0, 0)
ZEND_END_ARG_INFO()
