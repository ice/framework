...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_assets_getcollections, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_assets___construct, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_assets_getcss, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_assets_getjs, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_assets_zephir_init_properties_ice_assets, 0, 0, 0)
ZEND_END_ARG_INFO()
