...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_auth_social_google_getbirthday, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_auth_social_google_authenticate, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_auth_social_google_prepareauthparams, 0, 0, 0)
ZEND_END_ARG_INFO()
