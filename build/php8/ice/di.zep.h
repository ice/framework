...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_di_getdefaults, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_di_resolve, 0, 0, 2)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_di_getdependencies, 0, 0, 1)
	ZEND_ARG_ARRAY_INFO(0, parameters, 0)
#if PHP_VERSION_ID >= 80000
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, primitives, IS_ARRAY, 0, "[]")
#else
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_di_zephir_init_properties_ice_di, 0, 0, 0)
ZEND_END_ARG_INFO()
...
#if PHP_VERSION_ID >= 80000
	PHP_ME(Ice_Di, getDefaults, arginfo_ice_di_getdefaults, ZEND_ACC_PUBLIC)
#else
