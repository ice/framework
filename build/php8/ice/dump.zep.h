...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_dump_getdetailed, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_dump_getplain, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_dump_getskip, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_dump_zephir_init_properties_ice_dump, 0, 0, 0)
ZEND_END_ARG_INFO()
