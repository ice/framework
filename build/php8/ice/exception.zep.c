...
PHP_METHOD(Ice_Exception, __construct)
{
	...
	if (Z_TYPE_P(message) == IS_ARRAY) {
		ZVAL_LONG(&_0$$3, 1);
		ZEPHIR_CALL_FUNCTION(&values, "array_slice", NULL, 126, message, &_0$$3);
		zephir_check_call_status();
	...
	if (zephir_is_true(&_1)) {
		...
		ZEPHIR_CALL_FUNCTION(&_7$$6, "array_filter", NULL, 7, &_5$$6, &_6$$6);
		zephir_check_call_status();
...
PHP_METHOD(Ice_Exception, errorHandler)
{
	...
	if (((int) (zephir_get_numberval(&_0)) & code)) {
		...
		ZVAL_LONG(&_3$$3, 0);
		ZVAL_LONG(&_4$$3, line);
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 128, &message, &_2$$3, &_3$$3, &file, &_4$$3);
		zephir_check_call_status();
...
PHP_METHOD(Ice_Exception, shutdownHandler)
{
	...
	ZEPHIR_CALL_FUNCTION(&e, "error_get_last", NULL, 129);
	zephir_check_call_status();
	...
	if (_0) {
		ZEPHIR_CALL_FUNCTION(NULL, "ob_get_level", NULL, 130);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(NULL, "ob_clean", NULL, 131);
		zephir_check_call_status();
		...
		ZVAL_LONG(&_9$$3, 0);
		ZEPHIR_CALL_METHOD(NULL, &_4$$3, "__construct", NULL, 128, &_5$$3, &_6$$3, &_9$$3, &_7$$3, &_8$$3);
		zephir_check_call_status();
