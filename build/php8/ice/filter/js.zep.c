...
PHP_METHOD(Ice_Filter_Js, sanitize)
{
	...
	zephir_read_property(&_3, this_ptr, ZEND_STRL("input"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Ice_Filter_Js, action)
{
	...
	if (command == 1) {
		zephir_read_property(&_0$$3, this_ptr, ZEND_STRL("output"), PH_NOISY_CC | PH_READONLY);
		zephir_read_property(&_1$$3, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
	...
	if (_3) {
		zephir_read_property(&_4$$4, this_ptr, ZEND_STRL("b"), PH_NOISY_CC | PH_READONLY);
		...
		if (!(_6$$4)) {
			zephir_read_property(&_7$$4, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
		...
		if (_6$$4) {
			while (1) {
				...
				zephir_read_property(&_8$$6, this_ptr, ZEND_STRL("output"), PH_NOISY_CC | PH_READONLY);
				zephir_read_property(&_9$$6, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
				...
				zephir_read_property(&_13$$6, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
				zephir_read_property(&_14$$6, this_ptr, ZEND_STRL("b"), PH_NOISY_CC | PH_READONLY);
				if (ZEPHIR_IS_IDENTICAL(&_13$$6, &_14$$6)) {
					break;
				}
				zephir_read_property(&_15$$6, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
				...
				if (ZEPHIR_IS_STRING_IDENTICAL(&_18$$6, "\\")) {
					zephir_read_property(&_19$$9, this_ptr, ZEND_STRL("output"), PH_NOISY_CC | PH_READONLY);
					zephir_read_property(&_20$$9, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
	...
	if (_24) {
		...
		zephir_read_property(&_27$$10, this_ptr, ZEND_STRL("b"), PH_NOISY_CC | PH_READONLY);
		_28$$10 = ZEPHIR_IS_STRING_IDENTICAL(&_27$$10, "/");
		if (_28$$10) {
			zephir_read_property(&_29$$10, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
			_30$$10 = ZEPHIR_IS_STRING_IDENTICAL(&_29$$10, "(");
			if (!(_30$$10)) {
				zephir_read_property(&_31$$10, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
				_30$$10 = ZEPHIR_IS_STRING_IDENTICAL(&_31$$10, ",");
			}
			_32$$10 = _30$$10;
			if (!(_32$$10)) {
				zephir_read_property(&_33$$10, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
				_32$$10 = ZEPHIR_IS_STRING_IDENTICAL(&_33$$10, "=");
			}
			_34$$10 = _32$$10;
			if (!(_34$$10)) {
				zephir_read_property(&_35$$10, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
				_34$$10 = ZEPHIR_IS_STRING_IDENTICAL(&_35$$10, ":");
			}
			_36$$10 = _34$$10;
			if (!(_36$$10)) {
				zephir_read_property(&_37$$10, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
				_36$$10 = ZEPHIR_IS_STRING_IDENTICAL(&_37$$10, "[");
			}
			_38$$10 = _36$$10;
			if (!(_38$$10)) {
				zephir_read_property(&_39$$10, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
				_38$$10 = ZEPHIR_IS_STRING_IDENTICAL(&_39$$10, "!");
			}
			_40$$10 = _38$$10;
			if (!(_40$$10)) {
				zephir_read_property(&_41$$10, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
				_40$$10 = ZEPHIR_IS_STRING_IDENTICAL(&_41$$10, "&");
			}
			_42$$10 = _40$$10;
			if (!(_42$$10)) {
				zephir_read_property(&_43$$10, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
				_42$$10 = ZEPHIR_IS_STRING_IDENTICAL(&_43$$10, "|");
			}
			_44$$10 = _42$$10;
			if (!(_44$$10)) {
				zephir_read_property(&_45$$10, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
				_44$$10 = ZEPHIR_IS_STRING_IDENTICAL(&_45$$10, "?");
			}
			_46$$10 = _44$$10;
			if (!(_46$$10)) {
				zephir_read_property(&_47$$10, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
				_46$$10 = ZEPHIR_IS_STRING_IDENTICAL(&_47$$10, "{");
			}
			_48$$10 = _46$$10;
			if (!(_48$$10)) {
				zephir_read_property(&_49$$10, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
				_48$$10 = ZEPHIR_IS_STRING_IDENTICAL(&_49$$10, "}");
			}
			_50$$10 = _48$$10;
			if (!(_50$$10)) {
				zephir_read_property(&_51$$10, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
				_50$$10 = ZEPHIR_IS_STRING_IDENTICAL(&_51$$10, ";");
			}
			_52$$10 = _50$$10;
			if (!(_52$$10)) {
				zephir_read_property(&_53$$10, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
				_52$$10 = ZEPHIR_IS_STRING_IDENTICAL(&_53$$10, "\n");
			}
			_28$$10 = _52$$10;
		}
		if (_28$$10) {
			zephir_read_property(&_54$$11, this_ptr, ZEND_STRL("output"), PH_NOISY_CC | PH_READONLY);
			zephir_read_property(&_55$$11, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
			zephir_read_property(&_56$$11, this_ptr, ZEND_STRL("b"), PH_NOISY_CC | PH_READONLY);
			...
			while (1) {
				...
				zephir_read_property(&_59$$12, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
				zephir_read_property(&_60$$12, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
				zephir_read_property(&_61$$12, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
				zephir_read_property(&_62$$12, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
				...
				if (ZEPHIR_IS_STRING_IDENTICAL(&_59$$12, "[")) {
					while (1) {
						...
						zephir_read_property(&_64$$14, this_ptr, ZEND_STRL("output"), PH_NOISY_CC | PH_READONLY);
						zephir_read_property(&_65$$14, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
						...
						zephir_read_property(&_68$$14, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
						zephir_read_property(&_69$$14, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
						zephir_read_property(&_70$$14, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
						...
						if (ZEPHIR_IS_STRING_IDENTICAL(&_68$$14, "]")) {
							...
							zephir_read_property(&_72$$16, this_ptr, ZEND_STRL("output"), PH_NOISY_CC | PH_READONLY);
							zephir_read_property(&_73$$16, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
					...
					zephir_read_property(&_76$$19, this_ptr, ZEND_STRL("output"), PH_NOISY_CC | PH_READONLY);
					zephir_read_property(&_77$$19, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
				...
				zephir_read_property(&_80$$12, this_ptr, ZEND_STRL("output"), PH_NOISY_CC | PH_READONLY);
				zephir_read_property(&_81$$12, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Ice_Filter_Js, get)
{
	...
	ZEPHIR_OBS_VAR(&c);
	zephir_read_property(&c, this_ptr, ZEND_STRL("lookAhead"), PH_NOISY_CC);
	zephir_update_property_zval(this_ptr, ZEND_STRL("lookAhead"), &__$null);
	if (Z_TYPE_P(&c) == IS_NULL) {
		zephir_read_property(&_0$$3, this_ptr, ZEND_STRL("inputIndex"), PH_NOISY_CC | PH_READONLY);
		zephir_read_property(&_1$$3, this_ptr, ZEND_STRL("inputLength"), PH_NOISY_CC | PH_READONLY);
		if (ZEPHIR_LT(&_0$$3, &_1$$3)) {
			zephir_read_property(&_2$$4, this_ptr, ZEND_STRL("input"), PH_NOISY_CC | PH_READONLY);
			zephir_read_property(&_3$$4, this_ptr, ZEND_STRL("inputIndex"), PH_NOISY_CC | PH_READONLY);
			ZVAL_LONG(&_4$$4, 1);
			ZEPHIR_INIT_NVAR(&c);
			zephir_substr(&c, &_2$$4, zephir_get_intval(&_3$$4), 1 , 0);
			ZEPHIR_OBS_VAR(&i);
			zephir_read_property(&i, this_ptr, ZEND_STRL("inputIndex"), PH_NOISY_CC);
...
PHP_METHOD(Ice_Filter_Js, min)
{
	...
	ZVAL_STRING(&_1, "\xef");
	ZVAL_LONG(&_2, 1);
	ZEPHIR_CALL_FUNCTION(&_3, "strncmp", NULL, 83, &_0, &_1, &_2);
	zephir_check_call_status();
	...
	while (1) {
		...
		zephir_read_property(&_6$$4, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
		do {
			if (ZEPHIR_IS_STRING(&_6$$4, " ")) {
				zephir_read_property(&_8$$5, this_ptr, ZEND_STRL("b"), PH_NOISY_CC | PH_READONLY);
			...
			if (ZEPHIR_IS_STRING(&_6$$4, "\n")) {
				zephir_read_property(&_12$$8, this_ptr, ZEND_STRL("b"), PH_NOISY_CC | PH_READONLY);
				do {
					...
					zephir_read_property(&_16$$11, this_ptr, ZEND_STRL("b"), PH_NOISY_CC | PH_READONLY);
			...
			zephir_read_property(&_19$$14, this_ptr, ZEND_STRL("b"), PH_NOISY_CC | PH_READONLY);
			do {
				if (ZEPHIR_IS_STRING(&_19$$14, " ")) {
					zephir_read_property(&_21$$15, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
				...
				if (ZEPHIR_IS_STRING(&_19$$14, "\n")) {
					zephir_read_property(&_24$$17, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
					do {
						...
						zephir_read_property(&_27$$19, this_ptr, ZEND_STRL("a"), PH_NOISY_CC | PH_READONLY);
