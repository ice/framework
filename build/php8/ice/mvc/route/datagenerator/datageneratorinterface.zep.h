...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_mvc_route_datagenerator_datageneratorinterface_getdata, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(ice_mvc_route_datagenerator_datageneratorinterface_method_entry) {
	...
	PHP_ABSTRACT_ME(Ice_Mvc_Route_DataGenerator_DataGeneratorInterface, getData, arginfo_ice_mvc_route_datagenerator_datageneratorinterface_getdata)
	PHP_FE_END
};
