...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_mvc_view_getcontent, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_mvc_view_getmainview, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_mvc_view_getlayoutsdir, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_mvc_view_getpartialsdir, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_mvc_view_getviewsdir, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_mvc_view_getfile, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_mvc_view_getengines, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_ice_mvc_view___tostring, 0, 0, IS_STRING, 0)
#else
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_mvc_view___tostring, 0, 0, 0)
#endif
ZEND_END_ARG_INFO()
...
#if PHP_VERSION_ID >= 80000
	PHP_ME(Ice_Mvc_View, getContent, arginfo_ice_mvc_view_getcontent, ZEND_ACC_PUBLIC)
#else
...
#if PHP_VERSION_ID >= 80000
	PHP_ME(Ice_Mvc_View, getMainView, arginfo_ice_mvc_view_getmainview, ZEND_ACC_PUBLIC)
#else
...
#if PHP_VERSION_ID >= 80000
	PHP_ME(Ice_Mvc_View, getLayoutsDir, arginfo_ice_mvc_view_getlayoutsdir, ZEND_ACC_PUBLIC)
#else
...
#if PHP_VERSION_ID >= 80000
	PHP_ME(Ice_Mvc_View, getPartialsDir, arginfo_ice_mvc_view_getpartialsdir, ZEND_ACC_PUBLIC)
#else
...
#if PHP_VERSION_ID >= 80000
	PHP_ME(Ice_Mvc_View, getViewsDir, arginfo_ice_mvc_view_getviewsdir, ZEND_ACC_PUBLIC)
#else
...
#if PHP_VERSION_ID >= 80000
	PHP_ME(Ice_Mvc_View, getFile, arginfo_ice_mvc_view_getfile, ZEND_ACC_PUBLIC)
#else
...
#if PHP_VERSION_ID >= 80000
	PHP_ME(Ice_Mvc_View, getEngines, arginfo_ice_mvc_view_getengines, ZEND_ACC_PUBLIC)
#else
...
#if PHP_VERSION_ID >= 80000
	PHP_ME(Ice_Mvc_View, __toString, arginfo_ice_mvc_view___tostring, ZEND_ACC_PUBLIC)
#else
