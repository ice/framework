...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_validation_getdi, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_validation_getdata, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_validation_getrules, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_validation_gettranslate, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ice_validation_zephir_init_properties_ice_validation, 0, 0, 0)
ZEND_END_ARG_INFO()
