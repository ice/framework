...
extern zend_class_entry *ice_validation_validator_alnum_ce;
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_ice_validation_validator_alnum_validate, 0, 2, _IS_BOOL, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_ice_validation_validator_alnum_validate, 0, 2, _IS_BOOL, NULL, 0)
#endif
