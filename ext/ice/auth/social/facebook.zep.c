...
PHP_METHOD(Ice_Auth_Social_Facebook, authenticate) {
	...
	if (zephir_array_isset_string(_GET, SS("code"))) {
		...
		if (!(zephir_is_true(_1$$3))) {
			...
			ZVAL_STRING(_4$$4, "https://graph.facebook.com/oauth/access_token", ZEPHIR_TEMP_PARAM_COPY);
