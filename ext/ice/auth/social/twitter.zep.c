...
PHP_METHOD(Ice_Auth_Social_Twitter, authenticate) {
	...
	if (_0) {
		...
		ZEPHIR_CALL_METHOD(&_2, this_ptr, "prepareurlparams", &_3, 55, accessTokenUrl, params);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "parse_str", NULL, 52, accessTokens, accessTokens);
		...
		if (zephir_array_isset_string(accessTokens, SS("oauth_token"))) {
			...
			ZEPHIR_CALL_METHOD(&_2, this_ptr, "prepareurlparams", &_3, 55, getDataUrl, params, _6);
			zephir_check_call_status();
			ZEPHIR_CPY_WRT(params, _2);
			ZEPHIR_INIT_NVAR(_4);
			ZVAL_LONG(_4, 0);
...
PHP_METHOD(Ice_Auth_Social_Twitter, prepareUrlParams) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_5, "uniqid", NULL, 50, _4, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	zephir_md5(_3, _5);
	...
	ZEPHIR_CALL_FUNCTION(&_14, "array_map", NULL, 30, &_11, params);
	zephir_check_call_status();
