...
PHP_METHOD(Ice_Exception, __construct) {
	...
	if (Z_TYPE_P(message) == IS_ARRAY) {
		ZEPHIR_SINIT_VAR(_1);
		ZVAL_LONG(&_1, 1);
		ZEPHIR_CALL_FUNCTION(&values, "array_slice", NULL, 92, message, &_1);
		zephir_check_call_status();
		ZEPHIR_OBS_VAR(str);
...
PHP_METHOD(Ice_Exception, errorHandler) {
	...
	if (((int) (zephir_get_numberval(_0)) & code)) {
		...
		ZEPHIR_INIT_VAR(_4);
		ZVAL_LONG(_4, line);
		ZEPHIR_CALL_METHOD(NULL, _1, "__construct", NULL, 94, message, _2, _3, file, _4);
		zephir_check_call_status();
...
PHP_METHOD(Ice_Exception, shutdownHandler) {
	...
	if (_0) {
		...
		ZEPHIR_INIT_VAR(_8);
		ZVAL_LONG(_8, 0);
		ZEPHIR_CALL_METHOD(NULL, _3, "__construct", NULL, 94, _4, _5, _8, _6, _7);
		zephir_check_call_status();
