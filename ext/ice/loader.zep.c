...
PHP_METHOD(Ice_Loader, addNamespace) {
	...
	zephir_nts_static zephir_fcall_cache_entry *_15 = NULL, *_16 = NULL;
	int ZEPHIR_LAST_CALL_STATUS;
	...
	if (prepend) {
		...
		zephir_check_call_status();
		Z_SET_ISREF_P(_12);
		ZEPHIR_CALL_FUNCTION(NULL, "array_unshift", &_15, _12, _13);
		Z_UNSET_ISREF_P(_12);
		zephir_check_call_status();
	} else {
		_11 = zephir_fetch_nproperty_this(this_ptr, SL("_prefixes"), PH_NOISY_CC);
		...
		zephir_check_call_status();
		Z_SET_ISREF_P(_12);
		ZEPHIR_CALL_FUNCTION(NULL, "array_push", &_16, _12, _13);
		Z_UNSET_ISREF_P(_12);
		zephir_check_call_status();
	}
	RETURN_THIS();
...
PHP_METHOD(Ice_Loader, loadClass) {
	...
	zval *className_param = NULL, *prefix = NULL, *pos = NULL, *relativeClass = NULL, *mappedFile = NULL, _0 = zval_used_for_init, _2 = zval_used_for_init, *_5 = NULL;
	zval *className = NULL;
	...
	ZEPHIR_SINIT_VAR(_0);
	ZVAL_STRING(&_0, "\\", 0);
	ZEPHIR_CALL_FUNCTION(&pos, "strrpos", &_1, prefix, &_0);
	zephir_check_call_status();
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&prefix, "substr", &_3, className, &_0, &_2);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_0);
		ZVAL_LONG(&_0, (zephir_get_numberval(pos) + 1));
		ZEPHIR_CALL_FUNCTION(&relativeClass, "substr", &_3, className, &_0);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&mappedFile, this_ptr, "loadmappedfile", &_4, prefix, relativeClass);
		zephir_check_call_status();
		...
		ZEPHIR_SINIT_NVAR(_0);
		ZVAL_STRING(&_0, "\\", 0);
		zephir_fast_trim(_5, prefix, &_0, ZEPHIR_TRIM_RIGHT TSRMLS_CC);
		ZEPHIR_CPY_WRT(prefix, _5);
		ZEPHIR_SINIT_NVAR(_2);
		ZVAL_STRING(&_2, "\\", 0);
		ZEPHIR_CALL_FUNCTION(&pos, "strrpos", &_1, prefix, &_2);
		zephir_check_call_status();
	}
	RETURN_MM_BOOL(0);
...
PHP_METHOD(Ice_Loader, loadMappedFile) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_4, &_3)
		...
		ZEPHIR_CALL_METHOD(&_12, this_ptr, "requirefile", &_13, file);
		zephir_check_call_status();
