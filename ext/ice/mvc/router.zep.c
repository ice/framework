...
PHP_METHOD(Ice_Mvc_Router, fastRoute) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zend_class_entry *_7, *_10, *_23;
	zend_bool _2, _3, _20, _21;
	zval *_0;
	zval *options, *dispatcher = NULL, *data = NULL, *collector, *parser, *generator, *route = NULL, *handler = NULL, *_1, *_4 = NULL, *_5, *_6 = NULL, *_8, *_9 = NULL, *_12, *_13, **_16, *_17, *_18, *_19, *_22 = NULL, *_24 = NULL, *_25;
	...
	if (!(zephir_is_true(_12))) {
		...
		_13 = zephir_fetch_nproperty_this(this_ptr, SL("_routes"), PH_NOISY_CC);
		zephir_is_iterable(_13, &_15, &_14, 0, 0, "ice/mvc/router.zep", 106);
		for (
		  ; zephir_hash_get_current_data_ex(_15, (void**) &_16, &_14) == SUCCESS
		  ; zephir_hash_move_forward_ex(_15, &_14)
		) {
			ZEPHIR_GET_HVALUE(route, _16);
			ZEPHIR_OBS_NVAR(handler);
			zephir_array_isset_long_fetch(&handler, route, 2, 0 TSRMLS_CC);
			_17 = zephir_fetch_nproperty_this(this_ptr, SL("_collector"), PH_NOISY_CC);
			zephir_array_fetch_long(&_18, route, 0, PH_NOISY | PH_READONLY, "ice/mvc/router.zep", 104 TSRMLS_CC);
			zephir_array_fetch_long(&_19, route, 1, PH_NOISY | PH_READONLY, "ice/mvc/router.zep", 104 TSRMLS_CC);
			ZEPHIR_CALL_METHOD(NULL, _17, "addroute", NULL, _18, _19, handler);
			zephir_check_call_status();
		}
	}
	...
	if (_20) {
		...
		ZEPHIR_INIT_NVAR(_4);
		zephir_fetch_safe_class(_22, dispatcher);
		_23 = zend_fetch_class(Z_STRVAL_P(_22), Z_STRLEN_P(_22), ZEND_FETCH_CLASS_AUTO TSRMLS_CC);
		object_init_ex(_4, _23);
	...
	zephir_array_fetch_string(&_18, options, SL("cache"), PH_NOISY | PH_READONLY, "ice/mvc/router.zep", 115 TSRMLS_CC);
	if (zephir_is_true(_18)) {
		...
		zephir_array_fetch_string(&_18, options, SL("cacheFile"), PH_NOISY | PH_READONLY, "ice/mvc/router.zep", 120 TSRMLS_CC);
		if ((zephir_file_exists(_18 TSRMLS_CC) == SUCCESS)) {
			zephir_array_fetch_string(&_19, options, SL("cacheFile"), PH_NOISY | PH_READONLY, "ice/mvc/router.zep", 121 TSRMLS_CC);
			ZEPHIR_OBSERVE_OR_NULLIFY_PPZV(&_24);
			if (zephir_require_zval_ret(&_24, _19 TSRMLS_CC) == FAILURE) {
				RETURN_MM_NULL();
			}
			ZEPHIR_CPY_WRT(data, _24);
		} else {
			_13 = zephir_fetch_nproperty_this(this_ptr, SL("_collector"), PH_NOISY_CC);
			ZEPHIR_CALL_METHOD(&data, _13, "getdata", NULL);
			zephir_check_call_status();
			zephir_array_fetch_string(&_18, options, SL("cacheFile"), PH_NOISY | PH_READONLY, "ice/mvc/router.zep", 125 TSRMLS_CC);
			ZEPHIR_INIT_NVAR(_4);
			zephir_var_export_ex(_4, &(data) TSRMLS_CC);
			ZEPHIR_INIT_VAR(_25);
			ZEPHIR_CONCAT_SVS(_25, "<?php return ", _4, ";");
			zephir_file_put_contents(NULL, _18, _25 TSRMLS_CC);
		}
	} else {
		_13 = zephir_fetch_nproperty_this(this_ptr, SL("_collector"), PH_NOISY_CC);
		ZEPHIR_CALL_METHOD(&data, _13, "getdata", NULL);
	...
	ZEPHIR_CALL_METHOD(NULL, _13, "setdata", NULL, data);
	zephir_check_call_status();
