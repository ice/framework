...
PHP_METHOD(Ice_Tag, textField) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "input", NULL, 153, _0, parameters);
...
PHP_METHOD(Ice_Tag, friendlyTitle) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "extension_loaded", &_2, 154, &_0);
	zephir_check_call_status();
	if (zephir_is_true(_1)) {
		...
		ZEPHIR_CALL_FUNCTION(&locale, "setlocale", &_4, 155, &_0, &_3);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_0);
		ZVAL_STRING(&_0, "UTF-8", 0);
		ZEPHIR_SINIT_NVAR(_3);
		ZVAL_STRING(&_3, "ASCII//TRANSLIT", 0);
		ZEPHIR_CALL_FUNCTION(&_5, "iconv", NULL, 156, &_0, &_3, text);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&friendly, "preg_replace", &_13, 98, _11, _12, text);
	...
	ZEPHIR_CALL_FUNCTION(&_5, "preg_replace", &_13, 98, _11, separator, friendly);
	zephir_check_temp_parameter(_11);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_5, "extension_loaded", &_2, 154, &_3);
	zephir_check_call_status();
	if (zephir_is_true(_5)) {
		ZEPHIR_SINIT_NVAR(_3);
		ZVAL_LONG(&_3, 6);
		ZEPHIR_CALL_FUNCTION(NULL, "setlocale", &_4, 155, &_3, locale);
		zephir_check_call_status();
	}
