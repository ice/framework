...
ZEPHIR_INIT_CLASS(Ice_Validation_Validator_Alnum) {
	...
	ice_validation_validator_alnum_ce->create_object = zephir_init_properties;
	return SUCCESS;
...
PHP_METHOD(Ice_Validation_Validator_Alnum, validate) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "ctype_alnum", NULL, 157, value);
	zephir_check_call_status();
	if (!(zephir_is_true(_1))) {
		...
		ZEPHIR_CALL_FUNCTION(&_9, "strtr", NULL, 76, message, replace);
		zephir_check_call_status();
