...
PHP_METHOD(Ice_Validation_Validator_Alpha, validate) {
	...
	zval *field = NULL;
	zval *validation, *field_param = NULL, *value = NULL, *label = NULL, *message = NULL, *replace, *_1 = NULL, *_2 = NULL, *_3 = NULL, *_4 = NULL, *_5 = NULL;
	...
	if (!(zephir_is_true(_1))) {
		...
		ZEPHIR_CALL_FUNCTION(&_5, "strtr", &_6, message, replace);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, validation, "addmessage", NULL, field, _5);
		zephir_check_call_status();
		RETURN_MM_BOOL(0);
	}
	RETURN_MM_BOOL(1);
