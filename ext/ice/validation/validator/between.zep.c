...
PHP_METHOD(Ice_Validation_Validator_Between, validate) {
	...
	zval *field = NULL;
	zval *validation, *field_param = NULL, *value = NULL, *label = NULL, *message = NULL, *replace, *min = NULL, *max = NULL, *_1 = NULL, *_2 = NULL, *_3 = NULL, *_4 = NULL, *_6 = NULL, *_7 = NULL;
	...
	_5 = ZEPHIR_LT(value, min);
	if (!(_5)) {
		_5 = ZEPHIR_GT(value, max);
	}
	if (_5) {
		ZEPHIR_INIT_NVAR(_2);
