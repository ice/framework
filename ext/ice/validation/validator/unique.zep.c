...
PHP_METHOD(Ice_Validation_Validator_Unique, validate) {
	...
	zval *field = NULL;
	zval *validation, *field_param = NULL, *value = NULL, *label = NULL, *message = NULL, *i18n = NULL, *replace = NULL, *di = NULL, *db = NULL, *from = NULL, *custom = NULL, *except = NULL, *result = NULL, *id = NULL, *_2 = NULL, *_3, *_4, *_5 = NULL, *_6 = NULL, *_7 = NULL, *_8 = NULL, *_10 = NULL, *_11 = NULL, *_13 = NULL, *_14 = NULL, *_15 = NULL, *_16 = NULL;
	...
	if (zephir_is_true(result)) {
		...
		ZEPHIR_CALL_FUNCTION(&_15, "strtr", NULL, 85, message, replace);
		zephir_check_call_status();
