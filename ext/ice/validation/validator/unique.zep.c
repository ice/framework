...
PHP_METHOD(Ice_Validation_Validator_Unique, validate) {
	...
	ZEPHIR_INIT_VAR(_4);
	ZVAL_BOOL(_4, 1);
	ZEPHIR_CALL_METHOD(&db, di, "get", NULL, _2, _3, _4);
	...
	if (zephir_is_true(_5)) {
		ZEPHIR_INIT_NVAR(_2);
		ZVAL_LONG(_2, 0);
		ZEPHIR_CALL_METHOD(&from, this_ptr, "get", NULL, _2);
		zephir_check_call_status();
	} else {
		ZEPHIR_INIT_NVAR(_2);
	...
	if (zephir_is_true(_6)) {
		ZEPHIR_INIT_NVAR(_2);
		ZVAL_LONG(_2, 1);
		ZEPHIR_CALL_METHOD(&custom, this_ptr, "get", NULL, _2);
		zephir_check_call_status();
	} else {
		ZEPHIR_INIT_NVAR(_2);
	...
	if (zephir_is_true(_7)) {
		ZEPHIR_INIT_NVAR(_2);
		ZVAL_LONG(_2, 2);
		ZEPHIR_CALL_METHOD(&except, this_ptr, "get", NULL, _2);
		zephir_check_call_status();
	} else {
		ZEPHIR_INIT_NVAR(_2);
	...
	if (zephir_is_true(result)) {
		...
		if (_12) {
			...
			ZEPHIR_CALL_METHOD(&_14, _13, "has", NULL, _2);
			zephir_check_temp_parameter(_2);
			zephir_check_call_status();
		...
		if (_12) {
			...
			ZEPHIR_INIT_NVAR(_2);
			ZVAL_STRING(_2, "i18n", ZEPHIR_TEMP_PARAM_COPY);
			ZEPHIR_CALL_METHOD(&i18n, _15, "get", NULL, _2);
			zephir_check_temp_parameter(_2);
			zephir_check_call_status();
