...
PHP_METHOD(Ice_Validation_Validator_With, validate) {
	...
	zval *field = NULL;
	zval *validation, *field_param = NULL, *value = NULL, *label = NULL, *message = NULL, *replace, *fields = NULL, *with = NULL, *tmp = NULL, *required, *_1 = NULL, **_4, *_7 = NULL, *_8 = NULL, *_9 = NULL;
	...
	if (Z_TYPE_P(fields) != IS_ARRAY) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(ice_exception_ce, "Fields must be an array", "ice/validation/validator/with.zep", 29);
		return;
	}
	zephir_is_iterable(fields, &_3, &_2, 0, 0, "ice/validation/validator/with.zep", 40);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_3, &_2)
		...
		if (_6) {
			zephir_array_append(&required, with, PH_SEPARATE, "ice/validation/validator/with.zep", 36);
		}
	}
